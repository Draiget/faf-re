...
namespace
{
   ...
   */
  struct CDamageLuaFunctionRegistrationsLuaBinderBootstrap
  {
    CDamageLuaFunctionRegistrationsLuaBinderBootstrap()
    {
      (void)::moho::register_Damage_LuaFuncDef();
      (void)::moho::register_DamageArea_LuaFuncDef();
      (void)::moho::register_DamageRing_LuaFuncDef();
      (void)::moho::register_MetaImpact_LuaFuncDef();
    }
  };

  const CDamageLuaFunctionRegistrationsLuaBinderBootstrap gCDamageLuaFunctionRegistrationsLuaBinderBootstrap{};
} // namespace
...
namespace
{
   ...
   */
  struct CDamageLuaFunctionRegistrationsLuaFuncDefBootstrap
  {
    CDamageLuaFunctionRegistrationsLuaFuncDefBootstrap()
    {
      (void)::moho::func_CDamageGetInstigator_LuaFuncDef();
      (void)::moho::func_CDamageSetInstigator_LuaFuncDef();
      (void)::moho::func_CDamageGetTarget_LuaFuncDef();
      (void)::moho::func_CDamageSetTarget_LuaFuncDef();
    }
  };

  const CDamageLuaFunctionRegistrationsLuaFuncDefBootstrap gCDamageLuaFunctionRegistrationsLuaFuncDefBootstrap{};
} // namespace
