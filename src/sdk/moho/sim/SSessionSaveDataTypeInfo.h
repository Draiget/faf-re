...
namespace moho
{
  ...
  public:
    ...
    /**
     * Address: 0x008973B0 (FUN_008973B0, scalar deleting thunk)
     */
    ~SSessionSaveDataTypeInfo() override;

    /**
     * Address: 0x008973A0 (FUN_008973A0, Moho::SSessionSaveDataTypeInfo::GetName)
     */
    [[nodiscard]] const char* GetName() const override;

    /**
     * Address: 0x00897360 (FUN_00897360, Moho::SSessionSaveDataTypeInfo::Init)
     */
    void Init() override;
  ...
  /**
   * Address: 0x00BE7770 (FUN_00BE7770, register_SSessionSaveDataTypeInfo)
   */
