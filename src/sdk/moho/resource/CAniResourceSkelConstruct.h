...
namespace moho
{
  ...
  static_assert(
    offsetof(CAniResourceSkelConstruct, mHelperNext) == 0x04,
    "CAniResourceSkelConstruct::mHelperNext offset must be 0x04"
  );
  static_assert(
    offsetof(CAniResourceSkelConstruct, mHelperPrev) == 0x08,
    "CAniResourceSkelConstruct::mHelperPrev offset must be 0x08"
  );
  static_assert(
