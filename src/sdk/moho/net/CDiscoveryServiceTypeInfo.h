...
namespace moho
{
  ...
  public:
    ...
    /**
     * Address: 0x007BF5A0 (scalar deleting thunk)
     */
    ~CDiscoveryServiceTypeInfo() override;

    /**
     * Address: 0x007BF590 (Moho::CDiscoveryServiceTypeInfo::GetName)
     */
    [[nodiscard]] const char* GetName() const override;

    /**
     * Address: 0x007BF560 (Moho::CDiscoveryServiceTypeInfo::Init)
     */
    void Init() override;
  };
  ...
  /**
   * Address: 0x00BDFD90 (register_CDiscoveryServiceTypeInfo)
   */
