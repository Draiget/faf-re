...
namespace moho
{
  ...
  enum class ELobbyMsg : uint8_t
  {
    ...
    /**
     * Exclusive upper bound for lobby-message receiver range.
     * Not emitted as a normal lobby payload message.
     *
     * Binary evidence:
     * - FA 0x007C5CA0 (PushReceiver lower=0x64, upper=0x78)
     */
    LOBMSG_LobbyMsgEnd = 120,
    LOBMSG_HandshakeLast = LOBMSG_LobbyMsgEnd,
    ...
    /**
     * Exclusive upper bound for connection-event receiver range.
     * Not observed as an emitted message id in audited FA/Moho paths.
     *
     * Binary evidence:
     * - FA 0x0053BB60 / Moho 0x10129420 (PushReceiver lower=0xC8, upper=0xD2)
     */
    LOBMSG_ConnMsgEnd = 210,
    LOBMSG_Unknown6 = LOBMSG_ConnMsgEnd,
  };
} // namespace moho
