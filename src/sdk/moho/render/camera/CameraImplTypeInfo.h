...
namespace moho
{
  ...
  public:
    ...
    /**
     * Address: 0x007AAFD0 (scalar deleting thunk)
     */
    ~CameraImplTypeInfo() override;

    /**
     * Address: 0x007AAFC0 (Moho::CameraImplTypeInfo::GetName)
     */
    [[nodiscard]] const char* GetName() const override;

    /**
     * Address: 0x007AAF90 (Moho::CameraImplTypeInfo::Init)
     */
    void Init() override;
  };
  ...
  /**
   * Address: 0x00BDF5C0 (register_CameraImplTypeInfo)
   */
