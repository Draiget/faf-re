...
namespace
{
   ...
   */
  struct CUnitScriptTaskLuaFuncDefBootstrap
  {
    CUnitScriptTaskLuaFuncDefBootstrap()
    {
      (void)::moho::func_CUnitScriptTaskGetUnit_LuaFuncDef();
      (void)::moho::func_CUnitScriptTaskSetAIResult_LuaFuncDef();
      (void)::moho::func_LUnitMoveNear_LuaFuncDef();
    }
  };
