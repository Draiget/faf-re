...
namespace
{
  ...
  moho::IAniManipulator* ManipulatorFromActorOrderLinkSlot(
   ...
   */
  moho::TDatListItem<moho::IAniManipulator, void>* ReinsertManipulatorAtPrecedence(
...
namespace
{
   ...
   */
  struct IAniManipulatorLuaFuncDefBootstrap
  {
    IAniManipulatorLuaFuncDefBootstrap()
    {
      (void)::moho::func_IAniManipulatorSetPrecedence_LuaFuncDef();
      (void)::moho::func_IAniManipulatorEnable_LuaFuncDef();
      (void)::moho::func_IAniManipulatorDisable_LuaFuncDef();
      (void)::moho::func_IAniManipulatorDestroy_LuaFuncDef();
    }
  };

  const IAniManipulatorLuaFuncDefBootstrap gIAniManipulatorLuaFuncDefBootstrap{};
} // namespace
