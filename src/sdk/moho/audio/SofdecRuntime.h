...
namespace moho
{
  ...
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(MwsfdInitPrm, disp_latency) == 0x8, "MwsfdInitPrm::disp_latency offset must be 0x8");
  ...
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(MwsfdInitSfdParams, callbacks) == 0x00, "MwsfdInitSfdParams::callbacks offset must be 0x00");
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(MwsfdInitSfdParams, version) == 0x04, "MwsfdInitSfdParams::version offset must be 0x04");
  ...
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(MwsfdLibWork, displayRefreshHz) == 0x04, "MwsfdLibWork::displayRefreshHz offset must be 0x04");
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(MwsfdLibWork, displayCycle) == 0x08, "MwsfdLibWork::displayCycle offset must be 0x08");
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(MwsfdLibWork, displayLatency) == 0x0C, "MwsfdLibWork::displayLatency offset must be 0x0C");
  ...
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(MwsfdLibWork, lastErrorCode) == 0x68, "MwsfdLibWork::lastErrorCode offset must be 0x68");
  FAF_RUNTIME_LAYOUT_ASSERT(
  ...
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(SfplyFlowCount, producedBytes) == 0x00, "SfplyFlowCount::producedBytes offset must be 0x00");
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(SfplyFlowCount, consumedBytes) == 0x04, "SfplyFlowCount::consumedBytes offset must be 0x04");
  FAF_RUNTIME_LAYOUT_ASSERT(
    offsetof(SfplyFlowCount, producedPackets) == 0x08, "SfplyFlowCount::producedPackets offset must be 0x08"
  );
  FAF_RUNTIME_LAYOUT_ASSERT(
    offsetof(SfplyFlowCount, consumedPackets) == 0x0C, "SfplyFlowCount::consumedPackets offset must be 0x0C"
  );
  FAF_RUNTIME_LAYOUT_ASSERT(
    offsetof(SfplyFlowCount, producedFrames) == 0x10, "SfplyFlowCount::producedFrames offset must be 0x10"
  );
  FAF_RUNTIME_LAYOUT_ASSERT(
    offsetof(SfplyFlowCount, consumedFrames) == 0x14, "SfplyFlowCount::consumedFrames offset must be 0x14"
  );
  ...
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(SfplyMovieInfo, decodeDirection) == 0x1C, "SfplyMovieInfo::decodeDirection offset must be 0x1C");
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(SfplyMovieInfo, firstFrameIndex) == 0x24, "SfplyMovieInfo::firstFrameIndex offset must be 0x24");
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(SfplyMovieInfo, lastFrameIndex) == 0x28, "SfplyMovieInfo::lastFrameIndex offset must be 0x28");
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(SfplyMovieInfo, activeFrameIndex) == 0x2C, "SfplyMovieInfo::activeFrameIndex offset must be 0x2C");
  ...
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(SfplyPlaybackInfo, flowCounter0) == 0x38, "SfplyPlaybackInfo::flowCounter0 offset must be 0x38");
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(SfplyPlaybackInfo, flowCounter1) == 0x50, "SfplyPlaybackInfo::flowCounter1 offset must be 0x50");
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(SfplyPlaybackInfo, flowCounter2) == 0x68, "SfplyPlaybackInfo::flowCounter2 offset must be 0x68");
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(SfplyPlaybackInfo, flowCounter3) == 0x80, "SfplyPlaybackInfo::flowCounter3 offset must be 0x80");
  ...
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(SfplyTimerInfo, summaries) == 0x00, "SfplyTimerInfo::summaries offset must be 0x00");
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(SfplyTimerInfo, mUnknownC0) == 0xC0, "SfplyTimerInfo::mUnknownC0 offset must be 0xC0");
  ...
  FAF_RUNTIME_LAYOUT_ASSERT(
    offsetof(MwsstPauseGateVtable, queryStart) == 0x24, "MwsstPauseGateVtable::queryStart offset must be 0x24"
  );
  ...
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(MwsstStreamStateSubobj, state) == 0x00, "MwsstStreamStateSubobj::state offset must be 0x00");
  FAF_RUNTIME_LAYOUT_ASSERT(
    offsetof(MwsstStreamStateSubobj, pauseGate) == 0x0C, "MwsstStreamStateSubobj::pauseGate offset must be 0x0C"
  );
  FAF_RUNTIME_LAYOUT_ASSERT(
  ...
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(MwsfdPlaybackStateSubobj, used) == 0x00, "MwsfdPlaybackStateSubobj::used offset must be 0x00");
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(MwsfdPlaybackStateSubobj, fileType) == 0x08, "MwsfdPlaybackStateSubobj::fileType offset must be 0x08");
  FAF_RUNTIME_LAYOUT_ASSERT(
    offsetof(MwsfdPlaybackStateSubobj, framePoolSize) == 0x18,
    "MwsfdPlaybackStateSubobj::framePoolSize offset must be 0x18"
  );
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(MwsfdPlaybackStateSubobj, handle) == 0x3C, "MwsfdPlaybackStateSubobj::handle offset must be 0x3C");
  FAF_RUNTIME_LAYOUT_ASSERT(
    offsetof(MwsfdPlaybackStateSubobj, adxStreamHandle) == 0x40,
    "MwsfdPlaybackStateSubobj::adxStreamHandle offset must be 0x40"
  );
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(MwsfdPlaybackStateSubobj, lscHandle) == 0x48, "MwsfdPlaybackStateSubobj::lscHandle offset must be 0x48");
  FAF_RUNTIME_LAYOUT_ASSERT(
    offsetof(MwsfdPlaybackStateSubobj, concatPlayArmed) == 0x70,
    "MwsfdPlaybackStateSubobj::concatPlayArmed offset must be 0x70"
  );
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(MwsfdPlaybackStateSubobj, isPrepared) == 0x71, "MwsfdPlaybackStateSubobj::isPrepared offset must be 0x71");
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(MwsfdPlaybackStateSubobj, paused) == 0x72, "MwsfdPlaybackStateSubobj::paused offset must be 0x72");
  FAF_RUNTIME_LAYOUT_ASSERT(
  ...
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(MwsfdPlaybackStateSubobj, sfxHandle) == 0xA8, "MwsfdPlaybackStateSubobj::sfxHandle offset must be 0xA8");
  FAF_RUNTIME_LAYOUT_ASSERT(
  ...
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(MwsfdPlaybackStateSubobj, fname) == 0x1A4, "MwsfdPlaybackStateSubobj::fname offset must be 0x1A4");
  FAF_RUNTIME_LAYOUT_ASSERT(
  ...
  FAF_RUNTIME_LAYOUT_ASSERT(
    offsetof(MwsfdPlaybackStateSubobj, streamState) == 0x280, "MwsfdPlaybackStateSubobj::streamState offset must be 0x280"
  );
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(MwsfdPlaybackStateSubobj, apiType) == 0x2A4, "MwsfdPlaybackStateSubobj::apiType offset must be 0x2A4");
  ...
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(MwsfdFrameInfo, bufferAddress) == 0x00, "MwsfdFrameInfo::bufferAddress offset must be 0x00");
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(MwsfdFrameInfo, frameId) == 0x04, "MwsfdFrameInfo::frameId offset must be 0x04");
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(MwsfdFrameInfo, concatCount) == 0x24, "MwsfdFrameInfo::concatCount offset must be 0x24");
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(MwsfdFrameInfo, frameNumber) == 0x30, "MwsfdFrameInfo::frameNumber offset must be 0x30");
  ...
  FAF_RUNTIME_LAYOUT_ASSERT(
    offsetof(SofDecVirtualStateSubobj, readyFlag) == 0x8, "SofDecVirtualStateSubobj::readyFlag offset must be 0x8"
  );
  ...
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(AdxrnaTimingState, dispatchTable) == 0x00, "AdxrnaTimingState::dispatchTable offset must be 0x00");
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(AdxrnaTimingState, activeFlag) == 0x04, "AdxrnaTimingState::activeFlag offset must be 0x04");
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(AdxrnaTimingState, mode) == 0x08, "AdxrnaTimingState::mode offset must be 0x08");
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(AdxrnaTimingState, sampleRate) == 0x0C, "AdxrnaTimingState::sampleRate offset must be 0x0C");
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(AdxrnaTimingState, phaseModulo) == 0x10, "AdxrnaTimingState::phaseModulo offset must be 0x10");
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(AdxrnaTimingState, playheadSample) == 0x14, "AdxrnaTimingState::playheadSample offset must be 0x14");
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(AdxrnaTimingState, latchedSample) == 0x18, "AdxrnaTimingState::latchedSample offset must be 0x18");
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(AdxrnaTimingState, wrapPosition) == 0x1C, "AdxrnaTimingState::wrapPosition offset must be 0x1C");
  ...
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(SofdecPcmWaveFormat, formatTag) == 0x00, "SofdecPcmWaveFormat::formatTag offset must be 0x00");
  FAF_RUNTIME_LAYOUT_ASSERT(
    offsetof(SofdecPcmWaveFormat, channelCount) == 0x02, "SofdecPcmWaveFormat::channelCount offset must be 0x02"
  );
  FAF_RUNTIME_LAYOUT_ASSERT(
    offsetof(SofdecPcmWaveFormat, samplesPerSecond) == 0x04, "SofdecPcmWaveFormat::samplesPerSecond offset must be 0x04"
  );
  FAF_RUNTIME_LAYOUT_ASSERT(
  ...
  FAF_RUNTIME_LAYOUT_ASSERT(
    offsetof(SofdecPcmWaveFormat, blockAlignBytes) == 0x0C, "SofdecPcmWaveFormat::blockAlignBytes offset must be 0x0C"
  );
  FAF_RUNTIME_LAYOUT_ASSERT(
    offsetof(SofdecPcmWaveFormat, bitsPerSample) == 0x0E, "SofdecPcmWaveFormat::bitsPerSample offset must be 0x0E"
  );
  FAF_RUNTIME_LAYOUT_ASSERT(
    offsetof(SofdecPcmWaveFormat, extraBytes) == 0x10, "SofdecPcmWaveFormat::extraBytes offset must be 0x10"
  );
  ...
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(SofdecSoundPort, dispatchTable) == 0x00, "SofdecSoundPort::dispatchTable offset must be 0x00");
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(SofdecSoundPort, used) == 0x04, "SofdecSoundPort::used offset must be 0x04");
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(SofdecSoundPort, primaryBuffer) == 0x08, "SofdecSoundPort::primaryBuffer offset must be 0x08");
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(SofdecSoundPort, monoRoutingMode) == 0x0C, "SofdecSoundPort::monoRoutingMode offset must be 0x0C");
  FAF_RUNTIME_LAYOUT_ASSERT(
    offsetof(SofdecSoundPort, secondaryBuffer) == 0x10, "SofdecSoundPort::secondaryBuffer offset must be 0x10"
  );
  FAF_RUNTIME_LAYOUT_ASSERT(
  ...
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(SofdecSoundPort, balanceIndex) == 0x54, "SofdecSoundPort::balanceIndex offset must be 0x54");
  FAF_RUNTIME_LAYOUT_ASSERT(
    offsetof(SofdecSoundPort, baseVolumeMilliBel) == 0x58, "SofdecSoundPort::baseVolumeMilliBel offset must be 0x58"
  );
  FAF_RUNTIME_LAYOUT_ASSERT(
  ...
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(AdxBitstreamDecoderState, slotState) == 0x00, "AdxBitstreamDecoderState::slotState offset must be 0x00");
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(AdxBitstreamDecoderState, initState) == 0x02, "AdxBitstreamDecoderState::initState offset must be 0x02");
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(AdxBitstreamDecoderState, status) == 0x04, "AdxBitstreamDecoderState::status offset must be 0x04");
  FAF_RUNTIME_LAYOUT_ASSERT(
    offsetof(AdxBitstreamDecoderState, adxPacketDecoder) == 0x08,
    "AdxBitstreamDecoderState::adxPacketDecoder offset must be 0x08"
  );
  FAF_RUNTIME_LAYOUT_ASSERT(
    offsetof(AdxBitstreamDecoderState, headerType) == 0x0C, "AdxBitstreamDecoderState::headerType offset must be 0x0C"
  );
  FAF_RUNTIME_LAYOUT_ASSERT(
  ...
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(AdxBitstreamDecoderState, sampleRate) == 0x14, "AdxBitstreamDecoderState::sampleRate offset must be 0x14");
  FAF_RUNTIME_LAYOUT_ASSERT(
  ...
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(AdxBitstreamDecoderState, loopCount) == 0x24, "AdxBitstreamDecoderState::loopCount offset must be 0x24");
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(AdxBitstreamDecoderState, loopType) == 0x26, "AdxBitstreamDecoderState::loopType offset must be 0x26");
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(AdxBitstreamDecoderState, pcmBuffer0) == 0x3C, "AdxBitstreamDecoderState::pcmBuffer0 offset must be 0x3C");
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(AdxBitstreamDecoderState, pcmBuffer1) == 0x40, "AdxBitstreamDecoderState::pcmBuffer1 offset must be 0x40");
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(AdxBitstreamDecoderState, pcmBuffer2) == 0x44, "AdxBitstreamDecoderState::pcmBuffer2 offset must be 0x44");
  FAF_RUNTIME_LAYOUT_ASSERT(
    offsetof(AdxBitstreamDecoderState, outputChannels) == 0x50, "AdxBitstreamDecoderState::outputChannels offset must be 0x50"
  );
  FAF_RUNTIME_LAYOUT_ASSERT(
  ...
  FAF_RUNTIME_LAYOUT_ASSERT(
    offsetof(AdxBitstreamDecoderState, pcmBufferTag) == 0x38, "AdxBitstreamDecoderState::pcmBufferTag offset must be 0x38"
  );
  FAF_RUNTIME_LAYOUT_ASSERT(
  ...
  FAF_RUNTIME_LAYOUT_ASSERT(
    offsetof(AdxBitstreamDecoderState, decodeCursor) == 0x74, "AdxBitstreamDecoderState::decodeCursor offset must be 0x74"
  );
  FAF_RUNTIME_LAYOUT_ASSERT(
  ...
  FAF_RUNTIME_LAYOUT_ASSERT(
    offsetof(AdxBitstreamDecoderState, format) == 0x98, "AdxBitstreamDecoderState::format offset must be 0x98"
  );
  FAF_RUNTIME_LAYOUT_ASSERT(
  ...
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(AdxBitstreamDecoderState, extKey0) == 0xA0, "AdxBitstreamDecoderState::extKey0 offset must be 0xA0");
  FAF_RUNTIME_LAYOUT_ASSERT(
    offsetof(AdxBitstreamDecoderState, extKeyMultiplier) == 0xA2,
    "AdxBitstreamDecoderState::extKeyMultiplier offset must be 0xA2"
  );
  FAF_RUNTIME_LAYOUT_ASSERT(
    offsetof(AdxBitstreamDecoderState, extKeyAdder) == 0xA4, "AdxBitstreamDecoderState::extKeyAdder offset must be 0xA4"
  );
  FAF_RUNTIME_LAYOUT_ASSERT(
  ...
  FAF_RUNTIME_LAYOUT_ASSERT(
    offsetof(AdxBitstreamDecoderState, snapshotDelay0) == 0xAC, "AdxBitstreamDecoderState::snapshotDelay0 offset must be 0xAC"
  );
  FAF_RUNTIME_LAYOUT_ASSERT(
    offsetof(AdxBitstreamDecoderState, snapshotDelay1) == 0xB0, "AdxBitstreamDecoderState::snapshotDelay1 offset must be 0xB0"
  );
  FAF_RUNTIME_LAYOUT_ASSERT(
  ...
  FAF_RUNTIME_LAYOUT_ASSERT(
    offsetof(AdxBitstreamDecoderState, dataIdBytes) == 0xDC, "AdxBitstreamDecoderState::dataIdBytes offset must be 0xDC"
  );
  FAF_RUNTIME_LAYOUT_ASSERT(
  ...
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(SjChunkRange, bufferAddress) == 0x00, "SjChunkRange::bufferAddress offset must be 0x00");
  ...
  FAF_RUNTIME_LAYOUT_ASSERT(
    offsetof(SofdecSjUnifyChunkNode, next) == 0x00, "SofdecSjUnifyChunkNode::next offset must be 0x00"
  );
  FAF_RUNTIME_LAYOUT_ASSERT(
    offsetof(SofdecSjUnifyChunkNode, bufferAddress) == 0x08, "SofdecSjUnifyChunkNode::bufferAddress offset must be 0x08"
  );
  FAF_RUNTIME_LAYOUT_ASSERT(
    offsetof(SofdecSjUnifyChunkNode, byteCount) == 0x0C, "SofdecSjUnifyChunkNode::byteCount offset must be 0x0C"
  );
  ...
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(SofdecSjUnifyHandle, used) == 0x04, "SofdecSjUnifyHandle::used offset must be 0x04");
  FAF_RUNTIME_LAYOUT_ASSERT(
    offsetof(SofdecSjUnifyHandle, mergeAdjacentChunks) == 0x05,
    "SofdecSjUnifyHandle::mergeAdjacentChunks offset must be 0x05"
  );
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(SofdecSjUnifyHandle, uuid) == 0x08, "SofdecSjUnifyHandle::uuid offset must be 0x08");
  FAF_RUNTIME_LAYOUT_ASSERT(
    offsetof(SofdecSjUnifyHandle, chainPoolBase) == 0x0C, "SofdecSjUnifyHandle::chainPoolBase offset must be 0x0C"
  );
  FAF_RUNTIME_LAYOUT_ASSERT(
    offsetof(SofdecSjUnifyHandle, chainPoolCount) == 0x10, "SofdecSjUnifyHandle::chainPoolCount offset must be 0x10"
  );
  FAF_RUNTIME_LAYOUT_ASSERT(
  ...
  FAF_RUNTIME_LAYOUT_ASSERT(
    offsetof(SofdecSjUnifyHandle, laneHeads) == 0x18, "SofdecSjUnifyHandle::laneHeads offset must be 0x18"
  );
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(SofdecSjUnifyHandle, errFunc) == 0x28, "SofdecSjUnifyHandle::errFunc offset must be 0x28");
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(SofdecSjUnifyHandle, errObj) == 0x2C, "SofdecSjUnifyHandle::errObj offset must be 0x2C");
  ...
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(SofdecSjRingBufferHandle, used) == 0x04, "SofdecSjRingBufferHandle::used offset must be 0x04");
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(SofdecSjRingBufferHandle, uuid) == 0x08, "SofdecSjRingBufferHandle::uuid offset must be 0x08");
  FAF_RUNTIME_LAYOUT_ASSERT(
  ...
  FAF_RUNTIME_LAYOUT_ASSERT(
    offsetof(SofdecSjRingBufferHandle, lane0Cursor) == 0x14, "SofdecSjRingBufferHandle::lane0Cursor offset must be 0x14"
  );
  FAF_RUNTIME_LAYOUT_ASSERT(
    offsetof(SofdecSjRingBufferHandle, lane1Cursor) == 0x18, "SofdecSjRingBufferHandle::lane1Cursor offset must be 0x18"
  );
  FAF_RUNTIME_LAYOUT_ASSERT(
    offsetof(SofdecSjRingBufferHandle, bufferBase) == 0x1C, "SofdecSjRingBufferHandle::bufferBase offset must be 0x1C"
  );
  FAF_RUNTIME_LAYOUT_ASSERT(
    offsetof(SofdecSjRingBufferHandle, bufferSize) == 0x20, "SofdecSjRingBufferHandle::bufferSize offset must be 0x20"
  );
  FAF_RUNTIME_LAYOUT_ASSERT(
    offsetof(SofdecSjRingBufferHandle, extraSize) == 0x24, "SofdecSjRingBufferHandle::extraSize offset must be 0x24"
  );
  FAF_RUNTIME_LAYOUT_ASSERT(
  ...
  FAF_RUNTIME_LAYOUT_ASSERT(
    offsetof(SofdecSjRingBufferHandle, errFunc) == 0x38, "SofdecSjRingBufferHandle::errFunc offset must be 0x38"
  );
  FAF_RUNTIME_LAYOUT_ASSERT(
    offsetof(SofdecSjRingBufferHandle, errObj) == 0x3C, "SofdecSjRingBufferHandle::errObj offset must be 0x3C"
  );
  ...
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(SofdecSjMemoryHandle, used) == 0x04, "SofdecSjMemoryHandle::used offset must be 0x04");
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(SofdecSjMemoryHandle, uuid) == 0x08, "SofdecSjMemoryHandle::uuid offset must be 0x08");
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(SofdecSjMemoryHandle, errFunc) == 0x1C, "SofdecSjMemoryHandle::errFunc offset must be 0x1C");
  FAF_RUNTIME_LAYOUT_ASSERT(offsetof(SofdecSjMemoryHandle, errObj) == 0x20, "SofdecSjMemoryHandle::errObj offset must be 0x20");
...
extern "C"
{
  ...
  moho::SofdecPcmWaveFormat* SofdecBuildDefaultPcmWaveFormat(
    ...
    moho::SofdecPcmWaveFormat* outWaveFormat
  );
  ...
  moho::SofdecSoundPort* SofdecConfigureSpatialPreset(
    moho::SofdecSoundPort* soundPort,
    std::int32_t channelLane,
  ...
  std::int32_t SofdecControlSetValue(
    moho::SofdecSoundPort* soundPort,
    std::int32_t controlCode,
    std::int32_t controlValue
  );
  ...
  sfply_Create(const moho::SfplyCreateParams* createParams, std::int32_t createContext);
   ...
   */
  std::int32_t
  SFPLY_AddDecPic(moho::SofdecSfdWorkctrlSubobj* workctrlSubobj, std::int32_t decodedPictureDelta, std::int32_t callbackContext);
   ...
   */
  std::int32_t
  SFPLY_AddSkipPic(moho::SofdecSfdWorkctrlSubobj* workctrlSubobj, std::int32_t skippedPictureDelta, std::int32_t callbackContext);
   ...
   */
  std::int32_t SFXA_SetAlp3Prm(std::int32_t sfxaHandleAddress, std::int8_t alpha0, std::int8_t alpha1, std::int8_t alpha2);
  ...
  std::int32_t SFXA_GetAlp3Prm(
    std::int32_t sfxaHandleAddress,
    std::int8_t* outAlpha0,
    std::int8_t* outAlpha1,
    std::int8_t* outAlpha2
  );
   ...
   */
  std::int32_t sfbuf_MakeBufPtr(std::int32_t* outBufferPointers, const std::int32_t* ringBufferSizes, std::int32_t baseBufferAddress);
   ...
   */
  std::int32_t SFBUF_InitHn(std::int32_t vfrmOwnerAddress, std::int32_t sfbufHandleAddress, const std::int32_t* sfbufInitConfigWords);
   ...
   */
  std::int32_t SFBUF_SetSupplySj(moho::SofdecSfdWorkctrlSubobj* workctrlSubobj, const std::int32_t* supplyDescriptorWords);
   ...
   */
  std::int32_t SFBUF_GetRingSj(std::int32_t sfbufHandleAddress, std::int32_t laneIndex, std::int32_t* outRingHandleAddress);
   ...
   */
  std::int32_t SFBUF_RingGetSj(std::int32_t sfbufHandleAddress, std::int32_t ringIndex, std::int32_t* outRingHandleAddress);
   ...
   */
  std::int32_t SFBUF_AringGetWrite(std::int32_t sfbufHandleAddress, std::int32_t ringIndex, std::int32_t* outAringSnapshotWords);
   ...
   */
  std::int32_t SFBUF_AringGetRead(std::int32_t sfbufHandleAddress, std::int32_t ringIndex, std::int32_t* outAringSnapshotWords);
  ...
  std::int32_t SFBUF_GetFlowCnt(
    std::int32_t sjHandleAddress,
    std::int32_t* outLane1FlowCount,
    std::int32_t* outLane0FlowCount
  );
  ...
  std::int32_t sftrn_BuildAll(
    moho::SofdecSfdWorkctrlSubobj* workctrlSubobj,
    const std::int32_t* transferBuildConfigWords
  );
   ...
   */
  moho::SofdecSjRingBufferHandle* SJRBF_Create(std::int32_t bufferAddress, std::int32_t bufferSize, std::int32_t extraSize);
  ...
  moho::SofdecSjUnifyHandle* SJUNI_Create(
    std::uint8_t mergeAdjacentChunks,
    std::int32_t chainPoolAddress,
    std::int32_t chainPoolBytes
  );
   ...
   */
  std::int32_t ADXB_EntryData(moho::AdxBitstreamDecoderState* decoder, std::int32_t streamDataOffset, std::int32_t inputBytes);
