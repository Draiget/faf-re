...
namespace moho
{
   ...
   */
  class IAiCommandDispatchImplTypeInfo
  {
  public:
    /**
     * Address: 0x00401370
     ...
     */
    virtual ~IAiCommandDispatchImplTypeInfo() = default;

    /**
     * Address: 0x005991C0
     * Slot: 3
     * Demangled: Moho::IAiCommandDispatchImplTypeInfo::GetName
     */
     ...
     * Address: 0x00599190
     * Slot: 9
     * Demangled: Moho::IAiCommandDispatchImplTypeInfo::Init
     */
    virtual void Init() = 0;
