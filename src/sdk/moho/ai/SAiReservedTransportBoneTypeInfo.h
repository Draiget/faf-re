...
namespace moho
{
   ...
   */
  class SAiReservedTransportBoneTypeInfo
  {
  public:
    /**
     * Address: 0x00401370
     ...
     */
    virtual ~SAiReservedTransportBoneTypeInfo() = default;

    /**
     * Address: 0x005E3FE0
     * Slot: 3
     * Demangled: Moho::SAiReservedTransportBoneTypeInfo::GetName
     */
     ...
     * Address: 0x005E3FC0
     * Slot: 9
     * Demangled: Moho::SAiReservedTransportBoneTypeInfo::Init
     */
    virtual void Init() = 0;
