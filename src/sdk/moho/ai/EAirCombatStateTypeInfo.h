...
namespace moho
{
  ...
  public:
     ...
     */
    virtual ~EAirCombatStateTypeInfo() = default;

    /**
     * Address: 0x006B76F0
     * Slot: 3
     * Demangled: Moho::EAirCombatStateTypeInfo::GetName
     */
     ...
     * Address: 0x006B76D0
     * Slot: 9
     * Demangled: Moho::EAirCombatStateTypeInfo::Init
     */
    virtual void Init() = 0;
