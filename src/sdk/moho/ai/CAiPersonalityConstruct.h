...
namespace moho
{
   ...
   * COL:  0x00E72A98
   */
  class CAiPersonalityConstruct : public gpg::SerHelperBase
  {
  public:
    /**
     ...
     * installs `??_7CAiPersonalityConstruct@Moho@@6B@` -- no eager
     ...
     *
     * What it does:
     * Binds construct/delete callbacks into CAiPersonality RTTI. Dispatched
