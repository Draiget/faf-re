...
namespace moho
{
  ...
  static_assert(
    offsetof(CIntelCounterHandleConstruct, mNext) == 0x04, "CIntelCounterHandleConstruct::mNext offset must be 0x04"
  );
  static_assert(
    offsetof(CIntelCounterHandleConstruct, mPrev) == 0x08, "CIntelCounterHandleConstruct::mPrev offset must be 0x08"
  );
  static_assert(
