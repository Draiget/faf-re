...
namespace
{
   ...
   */
  struct PropLuaFuncDefBootstrap
  {
    PropLuaFuncDefBootstrap()
    {
      (void)::moho::func_PropAddBoundedProp_LuaFuncDef();
      (void)::moho::func_SplitProp_LuaFuncDef();
      (void)::moho::func_CreatePropHPR_LuaFuncDef();
    }
  };
