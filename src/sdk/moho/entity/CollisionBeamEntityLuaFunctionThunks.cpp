...
namespace
{
   ...
   */
  struct CollisionBeamEntityLuaFunctionThunksLuaFuncDefBootstrap
  {
    CollisionBeamEntityLuaFunctionThunksLuaFuncDefBootstrap()
    {
      ...
      (void)::moho::func_CollisionBeamEntityIsEnabled_LuaFuncDef();
      (void)::moho::func_CollisionBeamEntityGetLauncher_LuaFuncDef();
    }
  };

  const CollisionBeamEntityLuaFunctionThunksLuaFuncDefBootstrap gCollisionBeamEntityLuaFunctionThunksLuaFuncDefBootstrap{};
} // namespace
