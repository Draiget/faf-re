...
namespace
{
   ...
   */
  struct SCRColorLuaBinderBootstrap
  {
    SCRColorLuaBinderBootstrap()
    {
      (void)::moho::register_EnumColorNames_LuaFuncDef();
    }
  };

  const SCRColorLuaBinderBootstrap gSCRColorLuaBinderBootstrap{};
} // namespace
