...
namespace
{
   ...
   * `vZ`/`vX` are the scalar-first rotation matrix's row 0 / row 2 (see
...
namespace
{
   ...
   */
  struct EffectLuaStartupRegistrationsLuaFuncDefBootstrap
  {
    EffectLuaStartupRegistrationsLuaFuncDefBootstrap()
    {
      (void)::moho::func_IEffectSetBeamParam_LuaFuncDef();
      (void)::moho::func_IEffectSetEmitterParam_LuaFuncDef();
      (void)::moho::func_IEffectScaleEmitter_LuaFuncDef();
      (void)::moho::func_IEffectResizeEmitterCurve_LuaFuncDef();
      (void)::moho::func_IEffectSetEmitterCurveParam_LuaFuncDef();
      (void)::moho::func_IEffectOffsetEmitter_LuaFuncDef();
      (void)::moho::func_IEffectDestroy_LuaFuncDef();
      (void)::moho::func_CDecalHandleDestroy_LuaFuncDef();
      (void)::moho::func_CreateDecal_LuaFuncDef();
      (void)::moho::func_CreateSplat_LuaFuncDef();
      (void)::moho::func_CreateSplatOnBone_LuaFuncDef();
      (void)::moho::func_CreateEmitterAtEntity_LuaFuncDef();
      (void)::moho::func_CreateEmitterOnEntity_LuaFuncDef();
      (void)::moho::func_CreateLightParticle_LuaFuncDef();
      (void)::moho::func_CreateLightParticleIntel_LuaFuncDef();
      (void)::moho::func_CreateAttachedEmitter_LuaFuncDef();
      (void)::moho::func_CreateTrail_LuaFuncDef();
      (void)::moho::func_CreateAttachedBeam_LuaFuncDef();
      (void)::moho::func_CreateBeamToEntityBone_LuaFuncDef();
      (void)::moho::func_CreateEmitterAtBone_LuaFuncDef();
      (void)::moho::func_CreateBeamEmitter_LuaFuncDef();
      (void)::moho::func_CreateBeamEmitterOnEntity_LuaFuncDef();
  ...
  const EffectLuaStartupRegistrationsLuaFuncDefBootstrap gEffectLuaStartupRegistrationsLuaFuncDefBootstrap{};
} // namespace
