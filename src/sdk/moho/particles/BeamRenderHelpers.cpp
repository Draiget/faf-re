...
namespace
{
  ...
  )
  {
    ...
    // `msvc8::vector<SWorldBeam>`'s copy constructor (0x00497530, cited on
    // Vector.h) into the fresh entry's storage.
    ::new (static_cast<void*>(&destination->beams)) msvc8::vector<moho::SWorldBeam>(source->beams);
    return destination;
  }
