...
namespace Wm3
{
   ...
   */
  void TRational32::EliminatePowersOfTwo()
  {
    ...
    if (numerFirstNonZero > 63 || numerFirstNonZero == -1)
    {
      TInteger32 one{};
      std::memset(&one, 0, sizeof(one));
      int oneValue = 1;
      System::Memcpy(&one, 4u, &oneValue, 4u);
      System::Memcpy(&m_kDenom, sizeof(TInteger32), &one, sizeof(TInteger32));
      return;
    }
