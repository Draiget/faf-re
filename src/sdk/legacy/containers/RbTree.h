...
#define MSVC8_CONTAINER_PROXY_DEFINED 1
    ...
    namespace detail
    {
        ...
        public:
             ...
             * Address: 0x0049DC80 (FUN_0049DC80 -- `rb_iterator::operator++` for `ParticleBucketMap` (`msvc8::map<ParticleBucketKeyRuntime, ParticleRenderBucketRuntime*>`, 0x50-byte node); callers 0x00494E10, 0x00495080, 0x004952A0; formerly `MoveParticleBucketIteratorToNext` in moho/particles/CWorldParticles.cpp (RULE ONE), removed 2026-09-10.)
             * Address: 0x0049DCD0 (FUN_0049DCD0 -- `rb_iterator::operator++` for `TrailBucketMap` (`msvc8::map<TrailBucketKeyRuntime, TrailRenderBucketRuntime*>`, 0x50-byte node); callers 0x004966E2, 0x0049D520, 0x0049D924; formerly `MoveTrailBucketIteratorToNext` in moho/particles/CWorldParticles.cpp (RULE ONE), removed 2026-09-10.)
             * Address: 0x0049DE80 (FUN_0049DE80 -- `rb_iterator::operator++` for `ParticleBucketMap` (`msvc8::map<ParticleBucketKeyRuntime, ParticleRenderBucketRuntime*>`, 0x50-byte node); zero callers, unreachable; formerly `MoveParticleBucketIteratorToNextDuplicate` in moho/particles/CWorldParticles.cpp (RULE ONE), removed 2026-09-10.)
        ...
        public:
             ...
             * Address: 0x0049F390 (FUN_0049F390 -- `rb_tree()` -- buy the header sentinel and zero the size for `ParticleBucketMap` (`msvc8::map<ParticleBucketKeyRuntime, ParticleRenderBucketRuntime*>`, 0x50-byte node); zero callers, unreachable; formerly `InitializeParticleBucketTreeWithFreshHead` in moho/particles/CWorldParticles.cpp (RULE ONE), removed 2026-09-10.)
             * Address: 0x0049F3F0 (FUN_0049F3F0 -- `rb_tree()` -- buy the header sentinel and zero the size for `TrailBucketMap` (`msvc8::map<TrailBucketKeyRuntime, TrailRenderBucketRuntime*>`, 0x50-byte node); zero callers, unreachable; formerly `InitializeTrailBucketTreeWithFreshHead` in moho/particles/CWorldParticles.cpp (RULE ONE), removed 2026-09-10.)
             * Address: 0x004A01F0 (FUN_004A01F0 -- `rb_tree()` -- buy the header sentinel and zero the size for `ParticleBucketMap` (`msvc8::map<ParticleBucketKeyRuntime, ParticleRenderBucketRuntime*>`, 0x50-byte node); zero callers, unreachable; formerly `InitializeParticleBucketTreeWithFreshHeadDuplicateA` in moho/particles/CWorldParticles.cpp (RULE ONE), removed 2026-09-10.)
             * Address: 0x004A0230 (FUN_004A0230 -- `rb_tree()` -- buy the header sentinel and zero the size for `TrailBucketMap` (`msvc8::map<TrailBucketKeyRuntime, TrailRenderBucketRuntime*>`, 0x50-byte node); zero callers, unreachable; formerly `InitializeTrailBucketTreeWithFreshHeadDuplicateA` in moho/particles/CWorldParticles.cpp (RULE ONE), removed 2026-09-10.)
             * Address: 0x004A0750 (FUN_004A0750 -- `rb_tree()` -- buy the header sentinel and zero the size for `ParticleBucketMap` (`msvc8::map<ParticleBucketKeyRuntime, ParticleRenderBucketRuntime*>`, 0x50-byte node); zero callers, unreachable; formerly `InitializeParticleBucketTreeWithFreshHeadDuplicateB` in moho/particles/CWorldParticles.cpp (RULE ONE), removed 2026-09-10.)
             * Address: 0x004A0790 (FUN_004A0790 -- `rb_tree()` -- buy the header sentinel and zero the size for `TrailBucketMap` (`msvc8::map<TrailBucketKeyRuntime, TrailRenderBucketRuntime*>`, 0x50-byte node); zero callers, unreachable; formerly `InitializeTrailBucketTreeWithFreshHeadDuplicateB` in moho/particles/CWorldParticles.cpp (RULE ONE), removed 2026-09-10.)
             * Address: 0x004A07D0 (FUN_004A07D0 -- `rb_tree()` -- buy the header sentinel and zero the size for `ParticleBucketMap` (`msvc8::map<ParticleBucketKeyRuntime, ParticleRenderBucketRuntime*>`, 0x50-byte node); zero callers, unreachable; formerly `InitializeParticleBucketTreeWithFreshHeadDuplicateC` in moho/particles/CWorldParticles.cpp (RULE ONE), removed 2026-09-10.)
             * Address: 0x004A0800 (FUN_004A0800 -- `rb_tree()` -- buy the header sentinel and zero the size for `TrailBucketMap` (`msvc8::map<TrailBucketKeyRuntime, TrailRenderBucketRuntime*>`, 0x50-byte node); zero callers, unreachable; formerly `InitializeTrailBucketTreeWithFreshHeadDuplicateC` in moho/particles/CWorldParticles.cpp (RULE ONE), removed 2026-09-10.)
             * Address: 0x004A0830 (FUN_004A0830 -- `rb_tree()` -- buy the header sentinel and zero the size for `ParticleBucketMap` (`msvc8::map<ParticleBucketKeyRuntime, ParticleRenderBucketRuntime*>`, 0x50-byte node); zero callers, unreachable; formerly `InitializeParticleBucketTreeAndReturnHead` in moho/particles/CWorldParticles.cpp (RULE ONE), removed 2026-09-10.)
             * Address: 0x004A0880 (FUN_004A0880 -- `rb_tree()` -- buy the header sentinel and zero the size for `TrailBucketMap` (`msvc8::map<TrailBucketKeyRuntime, TrailRenderBucketRuntime*>`, 0x50-byte node); zero callers, unreachable; formerly `InitializeTrailBucketTreeAndReturnHead` in moho/particles/CWorldParticles.cpp (RULE ONE), removed 2026-09-10.)
             ...
             * Address: 0x004964C0 (FUN_004964C0 -- `end()` -- the header sentinel read for `ParticleBucketMap` (`msvc8::map<ParticleBucketKeyRuntime, ParticleRenderBucketRuntime*>`, 0x50-byte node); zero callers, unreachable; formerly `GetParticleBucketTreeHeadNode` in moho/particles/CWorldParticles.cpp (RULE ONE), removed 2026-09-10.)
             * Address: 0x00496670 (FUN_00496670 -- `end()` -- the header sentinel read for `TrailBucketMap` (`msvc8::map<TrailBucketKeyRuntime, TrailRenderBucketRuntime*>`, 0x50-byte node); zero callers, unreachable; formerly `GetTrailBucketTreeHeadNode` in moho/particles/CWorldParticles.cpp (RULE ONE), removed 2026-09-10.)
             * Address: 0x00496430 (FUN_00496430 -- `~rb_tree` (clear + free the header) for `ParticleBucketMap` (`msvc8::map<ParticleBucketKeyRuntime, ParticleRenderBucketRuntime*>`, 0x50-byte node); callers 0x004925E0, 0x00492780, 0x00493131; formerly `ReleaseParticleBucketTreeStorage` in moho/particles/CWorldParticles.cpp (RULE ONE), removed 2026-09-10.)
             * Address: 0x004965E0 (FUN_004965E0 -- `~rb_tree` (clear + free the header) for `TrailBucketMap` (`msvc8::map<TrailBucketKeyRuntime, TrailRenderBucketRuntime*>`, 0x50-byte node); callers 0x004925E0, 0x00492780, 0x00493141; formerly `ReleaseTrailBucketTreeStorage` in moho/particles/CWorldParticles.cpp (RULE ONE), removed 2026-09-10.)
             * Address: 0x00498360 (FUN_00498360 -- `end()` -- the header sentinel read for `ParticleBucketMap` (`msvc8::map<ParticleBucketKeyRuntime, ParticleRenderBucketRuntime*>`, 0x50-byte node); zero callers, unreachable; formerly `GetParticleBucketTreeHeadNodeDuplicate` in moho/particles/CWorldParticles.cpp (RULE ONE), removed 2026-09-10.)
             ...
             * Address: 0x004964B0 (FUN_004964B0 -- `_Lmost` / `begin()` for `ParticleBucketMap` (`msvc8::map<ParticleBucketKeyRuntime, ParticleRenderBucketRuntime*>`, 0x50-byte node); zero callers, unreachable; formerly `GetParticleBucketTreeBeginNode` in moho/particles/CWorldParticles.cpp (RULE ONE), removed 2026-09-10.)
             * Address: 0x00496660 (FUN_00496660 -- `_Lmost` / `begin()` for `TrailBucketMap` (`msvc8::map<TrailBucketKeyRuntime, TrailRenderBucketRuntime*>`, 0x50-byte node); zero callers, unreachable; formerly `GetTrailBucketTreeBeginNode` in moho/particles/CWorldParticles.cpp (RULE ONE), removed 2026-09-10.)
             * Address: 0x00498350 (FUN_00498350 -- `_Lmost` / `begin()` for `ParticleBucketMap` (`msvc8::map<ParticleBucketKeyRuntime, ParticleRenderBucketRuntime*>`, 0x50-byte node); zero callers, unreachable; formerly `GetParticleBucketTreeBeginNodeDuplicate` in moho/particles/CWorldParticles.cpp (RULE ONE), removed 2026-09-10.)
             ...
             * Address: 0x004963E0 (FUN_004963E0 -- `find` (lower_bound plus the equivalence check) for `ParticleBucketMap` (`msvc8::map<ParticleBucketKeyRuntime, ParticleRenderBucketRuntime*>`, 0x50-byte node); callers 0x00494930; formerly `ResolveParticleBucketCandidateOrHead` in moho/particles/CWorldParticles.cpp (RULE ONE), removed 2026-09-10.)
             ...
             * Address: 0x0049C7A0 (FUN_0049C7A0 -- `_Insert` unique for `ParticleBucketMap` (`msvc8::map<ParticleBucketKeyRuntime, ParticleRenderBucketRuntime*>`, 0x50-byte node); callers 0x0049A870; formerly `InsertParticleBucketTreeEntryAtHint` in moho/particles/CWorldParticles.cpp (RULE ONE), removed 2026-09-10.)
             * Address: 0x0049CAF0 (FUN_0049CAF0 -- `_Insert` unique for `TrailBucketMap` (`msvc8::map<TrailBucketKeyRuntime, TrailRenderBucketRuntime*>`, 0x50-byte node); callers 0x0049AAB0; formerly `InsertTrailBucketTreeEntryAtHint` in moho/particles/CWorldParticles.cpp (RULE ONE), removed 2026-09-10.)
             * Address: 0x0049A870 (FUN_0049A870 -- `_Insert` unique for `ParticleBucketMap` (`msvc8::map<ParticleBucketKeyRuntime, ParticleRenderBucketRuntime*>`, 0x50-byte node); callers 0x004981C0; formerly `InsertParticleBucketEntryOrResolveDuplicate` in moho/particles/CWorldParticles.cpp (RULE ONE), removed 2026-09-10.)
             * Address: 0x0049AAB0 (FUN_0049AAB0 -- `_Insert` unique for `TrailBucketMap` (`msvc8::map<TrailBucketKeyRuntime, TrailRenderBucketRuntime*>`, 0x50-byte node); callers 0x00498470; formerly `InsertTrailBucketEntryOrResolveDuplicate` in moho/particles/CWorldParticles.cpp (RULE ONE), removed 2026-09-10.)
             ...
             * Address: 0x0049D0D0 (FUN_0049D0D0 -- `_Erase` (unlink, lift the successor, free the node) for `ParticleBucketMap` (`msvc8::map<ParticleBucketKeyRuntime, ParticleRenderBucketRuntime*>`, 0x50-byte node); callers 0x0049C6E0; formerly `EraseParticleBucketTreeKeyNode` in moho/particles/CWorldParticles.cpp (RULE ONE), removed 2026-09-10.)
        ...
        private:
             ...
             * Address: 0x0049ECD0 (FUN_0049ECD0 -- `_Buynode(value)` for `ParticleBucketMap` (`msvc8::map<ParticleBucketKeyRuntime, ParticleRenderBucketRuntime*>`, 0x50-byte node); callers 0x0049D430, 0x0049DA30, 0x004A08D0; formerly `AllocateParticleBucketTreeEntryNodeArrayOrThrow` in moho/particles/CWorldParticles.cpp (RULE ONE), removed 2026-09-10.)
             * Address: 0x0049ED20 (FUN_0049ED20 -- `_Buynode(value)` for `TrailBucketMap` (`msvc8::map<TrailBucketKeyRuntime, TrailRenderBucketRuntime*>`, 0x50-byte node); callers 0x0049D880, 0x0049DB00, 0x004A0920; formerly `AllocateTrailBucketTreeEntryNodeArrayOrThrow` in moho/particles/CWorldParticles.cpp (RULE ONE), removed 2026-09-10.)
             * Address: 0x0049DBC0 (FUN_0049DBC0 -- `_Buynode(value)` for `ParticleBucketMap` (`msvc8::map<ParticleBucketKeyRuntime, ParticleRenderBucketRuntime*>`, 0x50-byte node); zero callers, unreachable; formerly `InitializeParticleBucketTreeEntryNodeWithLinksAndPayload` in moho/particles/CWorldParticles.cpp (RULE ONE), removed 2026-09-10.)
             * Address: 0x0049DBF0 (FUN_0049DBF0 -- `_Buynode(value)` for `TrailBucketMap` (`msvc8::map<TrailBucketKeyRuntime, TrailRenderBucketRuntime*>`, 0x50-byte node); zero callers, unreachable; formerly `InitializeTrailBucketTreeEntryNodeWithLinksAndPayload` in moho/particles/CWorldParticles.cpp (RULE ONE), removed 2026-09-10.)
             * Address: 0x0049D430 (FUN_0049D430 -- `_Buynode(value)` for `ParticleBucketMap` (`msvc8::map<ParticleBucketKeyRuntime, ParticleRenderBucketRuntime*>`, 0x50-byte node); callers 0x0049C7A0; formerly `AllocateParticleBucketTreeEntryNodeWithLinks` in moho/particles/CWorldParticles.cpp (RULE ONE), removed 2026-09-10.)
             * Address: 0x0049D880 (FUN_0049D880 -- `_Buynode(value)` for `TrailBucketMap` (`msvc8::map<TrailBucketKeyRuntime, TrailRenderBucketRuntime*>`, 0x50-byte node); callers 0x0049CAF0; formerly `AllocateTrailBucketTreeEntryNodeWithLinks` in moho/particles/CWorldParticles.cpp (RULE ONE), removed 2026-09-10.)
             * Address: 0x004A08D0 (FUN_004A08D0 -- `_Buynode(value)` for `ParticleBucketMap` (`msvc8::map<ParticleBucketKeyRuntime, ParticleRenderBucketRuntime*>`, 0x50-byte node); callers 0x004925E0, 0x004963A0, 0x00498190; formerly `AllocateParticleBucketTreeNodeWithNullLinksBlack` in moho/particles/CWorldParticles.cpp (RULE ONE), removed 2026-09-10.)
             ...
             * Address: 0x0049E150 (FUN_0049E150 -- `_Erase(root)` (the recursive teardown) for `ParticleBucketMap` (`msvc8::map<ParticleBucketKeyRuntime, ParticleRenderBucketRuntime*>`, 0x50-byte node); callers 0x00494E10, 0x00496430, 0x004964DA; formerly `DestroyParticleBucketPayloadRange` in moho/particles/CWorldParticles.cpp (RULE ONE), removed 2026-09-10.)
