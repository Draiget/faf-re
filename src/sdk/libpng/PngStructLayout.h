...
constexpr std::size_t kOffTransValRed       = 0x18E;  //   .red
constexpr std::size_t kOffTransValGreen     = 0x190;  //   .green
constexpr std::size_t kOffTransValBlue      = 0x192;  //   .blue
...
constexpr std::size_t kOffFilterType        = 0x238;  // png_byte     filter_type (IHDR)
