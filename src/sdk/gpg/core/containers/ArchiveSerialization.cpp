...
{
  /**
   * `InstallSerSaveLoadHelperCallbacksByTypeName` -- the shared dispatcher
   * behind every `InstallMoho<X>SerializerCallbacks`/
   * `InstallWm3<X>SerializerCallbacks` wrapper in this file -- along with its
   * `SerSaveLoadHelperInitView` raw offset-reach-in parameter struct, the
   * `kSerializationHeaderPath` constant it used for its two
   * `gpg::HandleAssertFailure` call sites, and the never-referenced
   * `SerializerWord` alias, are removed here (2026-08-26 ArchiveSerialization
   * audit, closing pass).
   *
   * This dispatcher had no `Address:` citation of its own -- it modeled a
   * `gpg::REF_FindTypeNamed`-by-string-name lookup mechanism that ground-
   * truth `.c` disassembly never once confirmed. Every one of its originally
   * ~114 `InstallMoho<X>SerializerCallbacks`-family callers, checked one by
   * one against its own raw asm across this and earlier sessions, turned out
   * to be a disproven duplicate citation of the ordinary typeid-cached
   * `gpg::LookupRType` + direct-assignment `Init()` shape (either
   * `gpg::SerSaveLoadHelper<T>::Init()` or `gpg::PrimitiveSerHelper<T,int>::
   * Init()`), already correctly recovered elsewhere in the SDK tree as a
   * named `Init()` override on the owning type's real `gpg::SerHelperBase`-
   * derived serializer class. See the individual removal notes throughout
   * this file and
   * decomp/recovery/reports/by-source/src/sdk/gpg/core/containers/ArchiveSerialization.cpp.reconstruction.md
   * for the per-type evidence.
   *
   * `InstallMohoETriggerOperatorSerializerCallbacks` and
   * `InstallMohoEScrollTypeSerializerCallbacks` (removed further below) were
   * this dispatcher's last two live callers in this file; with those gone it
   * has zero remaining callers anywhere in `src/sdk/**`, so it -- and its
   * now-equally-dead supporting struct/constant/alias -- are removed as dead
   * scaffolding rather than left as an orphan. This closes out the
   * `InstallMoho<X>SerializerCallbacks` dead-duplicate cleanup campaign for
   * this file: zero live `InstallSerSaveLoadHelperCallbacksByTypeName(helper,`
   * call sites remain.
   */
  ...
  /**
   * `InstallMohoCUnitAssistMoveTaskSerializerCallbacks` removed here
   * (2026-08-26 ArchiveSerialization audit): its `Address: 0x005F1A70`
   * citation was disproven -- ground-truth `.c` disassembly shows the
   * standard direct-assignment `Init()` shape (`type->serLoadFunc_ = ...` /
   * `->mSerLoadFunc = ...`), not the generic by-name lookup this file
   * modeled, and had zero callers in this file. Real body is
   * `moho::CUnitAssistMoveTaskSerializer::Init()` in
   * moho/unit/tasks/CUnitAssistMoveTask.cpp.
   */
  ...
  /**
   * `InstallMohoCUnitSacrificeTaskSerializerCallbacks` removed here (2026-08-26
   * ArchiveSerialization audit): its `Address: 0x005FBED0` citation was
   * disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Address cited elsewhere as the real Init():
   * moho/unit/tasks/CUnitSacrificeTask.cpp.
   */

  /**
   * `InstallMohoCUnitCaptureTaskSerializerCallbacks` removed here (2026-08-26
   * ArchiveSerialization audit): its `Address: 0x00605320` citation was
   * disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Address cited elsewhere as the real Init():
   * moho/unit/tasks/CUnitCaptureTaskSerializer.cpp,
   * moho/unit/tasks/CUnitCaptureTaskSerializer.h.
   */
  ...
  /**
   * `InstallMohoCUnitCarrierLandSerializerCallbacks` removed here (2026-08-26
   * ArchiveSerialization audit): its `Address: 0x006077F0` citation was
   * disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Address cited elsewhere as the real Init():
   * moho/unit/tasks/CUnitCarrierLandTypeInfo.cpp.
   */
  ...
  /**
   * `InstallMohoEAiResultSerializerCallbacks` removed here (2026-08-26
   * ArchiveSerialization audit): its `Address: 0x0060B980` citation was
   * disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Address cited elsewhere as the real Init():
   * gpg/core/reflection/Reflection.h, moho/ai/EAiResultTypeInfo.h.
   */

  /**
   * `InstallMohoCUnitGetBuiltTaskSerializerCallbacks` removed here (2026-08-26
   * ArchiveSerialization audit): its `Address: 0x0060BAE0` citation was
   * disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Address cited elsewhere as the real Init():
   * moho/unit/tasks/CUnitGetBuiltTask.cpp.
   */
} // namespace
...
namespace
{
  ...
  /**
   * `InstallMohoCUnitTeleportTaskSerializerCallbacks` removed here
   * (2026-08-26 ArchiveSerialization audit): its `Address: 0x0060BBA0`
   * citation was disproven -- ground-truth `.c` disassembly shows the
   * standard direct-assignment `Init()` shape (`type->serLoadFunc_ = ...` /
   * `->mSerLoadFunc = ...`), not the generic by-name lookup this file
   * modeled, and had zero callers in this file. Real body is
   * `gpg::SerSaveLoadHelper<CUnitTeleportTask>::Init()`, inherited unchanged
   * by `moho::CUnitTeleportTaskSerializer` in
   * moho/unit/tasks/CUnitCallTeleport.h.
   */

  /**
   * `InstallMohoCUnitFireAtTaskSerializerCallbacks` removed here (2026-08-26
   * ArchiveSerialization audit): its `Address: 0x0060BC60` citation was
   * disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Re-checked deliberately against this session's own
   * earlier recollection of `CUnitFireAtTask`'s callback addresses as
   * 0x0060D430/0x0060D510 before removing: those two addresses are
   * `CUnitFireAtTask::MemberDeserialize`/`MemberSerialize` (the load/save
   * callback bodies `Init()` installs), a *different* pair of functions from
   * `Init()` itself -- not a conflicting citation. Real body is
   * `gpg::SerSaveLoadHelper<CUnitFireAtTask>::Init()`, inherited unchanged by
   * `moho::CUnitFireAtTaskSerializer` in moho/unit/tasks/CUnitFireAtTask.h,
   * which already separately and correctly cites 0x0060BC60 for `Init()` and
   * 0x0060D430/0x0060D510 for the two member (de)serialize bodies.
   */

  /**
   * `InstallMohoCUnitFerryTaskSerializerCallbacks` removed here (2026-08-26
   * ArchiveSerialization audit): its `Address: 0x00610000` citation was
   * disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Address cited elsewhere as the real Init():
   * moho/unit/tasks/CUnitFerryTask.cpp, moho/unit/tasks/CUnitFerryTask.h.
   */

  /**
   * `InstallMohoCUnitWaitForFerryTaskSerializerCallbacks` removed here
   * (2026-08-26 ArchiveSerialization audit): its `Address: 0x006100C0` citation
   * was disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Address cited elsewhere as the real Init():
   * moho/unit/tasks/CUnitWaitForFerryTask.cpp.
   */

  /**
   * `InstallMohoCUnitGuardTaskSerializerCallbacks` removed here (2026-08-26
   * ArchiveSerialization audit): its `Address: 0x006148A0` citation was
   * disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Address cited elsewhere as the real Init():
   * moho/unit/tasks/CUnitGuardTask.cpp.
   */

  /**
   * `InstallMohoCUnitMoveTaskSerializerCallbacks` removed here (2026-08-26
   * ArchiveSerialization audit): its `Address: 0x00619C20` citation was
   * disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Address cited elsewhere as the real Init():
   * moho/unit/tasks/CUnitMoveTask.cpp.
   */

  /**
   * `InstallMohoCUnitFormAndMoveTaskSerializerCallbacks` removed here
   * (2026-08-26 ArchiveSerialization audit): its `Address: 0x00619CE0`
   * citation was disproven -- ground-truth `.c` disassembly shows the
   * standard direct-assignment `Init()` shape (`type->serLoadFunc_ = ...` /
   * `->mSerLoadFunc = ...`), not the generic by-name lookup this file
   * modeled, and had zero callers in this file. Real body is
   * `gpg::SerSaveLoadHelper<CUnitFormAndMoveTask>::Init()`, inherited
   * unchanged by `moho::CUnitFormAndMoveTaskSerializer` in
   * moho/unit/tasks/CUnitFormAndMoveTask.cpp.
   */

  /**
   * `InstallMohoCUnitPatrolTaskSerializerCallbacks` removed here (2026-08-26
   * ArchiveSerialization audit): its `Address: 0x0061C6E0` citation was
   * disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Address cited elsewhere as the real Init():
   * moho/unit/tasks/CUnitPatrolTask.cpp.
   */

  /**
   * `InstallMohoCUnitPodAssistSerializerCallbacks` removed here (2026-08-26
   * ArchiveSerialization audit): its `Address: 0x0061E500` citation was
   * disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Address cited elsewhere as the real Init():
   * moho/unit/tasks/CUnitPodAssist.cpp.
   */

  /**
   * `InstallMohoCUnitReclaimTaskSerializerCallbacks` removed here (2026-08-26
   * ArchiveSerialization audit): its `Address: 0x006204B0` citation was
   * disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Address cited elsewhere as the real Init():
   * moho/unit/tasks/CUnitReclaimTask.cpp.
   */

  /**
   * `InstallMohoCUnitRefuelSerializerCallbacks` removed here (2026-08-26
   * ArchiveSerialization audit): its `Address: 0x00622210` citation was
   * disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Address cited elsewhere as the real Init():
   * moho/unit/tasks/CUnitRefuel.cpp.
   */

  /**
   * `InstallMohoSPickUpInfoSerializerCallbacks` removed here (2026-08-26
   * ArchiveSerialization audit): its `Address: 0x00626B30` citation was
   * disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Real body is Moho::SPickUpInfoSerializer::Init() (or
   * equivalent) in moho/ai/SPickUpInfo.cpp, moho/ai/SPickUpInfo.h.
   */

  /**
   * `InstallMohoCUnitLoadUnitsSerializerCallbacks` removed here (2026-08-26
   * ArchiveSerialization audit): its `Address: 0x00626F90` citation was
   * disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Address cited elsewhere as the real Init():
   * moho/unit/tasks/CUnitLoadUnitsSerializer.cpp,
   * moho/unit/tasks/CUnitLoadUnitsSerializer.h.
   */

  /**
   * `InstallMohoCUnitUnloadUnitsSerializerCallbacks` removed here (2026-08-26
   * ArchiveSerialization audit): its `Address: 0x00627050` citation was
   * disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Real body is
   * `gpg::SerSaveLoadHelper<CUnitUnloadUnits>::Init()`, inherited unchanged
   * by `moho::CUnitUnloadUnitsSerializer` in
   * moho/unit/tasks/CUnitUnloadUnits.cpp.
   */

  /**
   * `InstallMohoEPathPointStateSerializerCallbacks` removed here (2026-08-26
   * ArchiveSerialization audit): its `Address: 0x0062F870` citation was
   * disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Real body is
   * gpg::PrimitiveSerHelper<EPathPointState,int>::Init(), instantiated in
   * moho/ai/CAiPathSpline.h.
   */

  /**
   * `InstallMohoCBoneEntityManipulatorSerializerCallbacks` removed here
   * (2026-08-26 ArchiveSerialization audit): its `Address: 0x00635140` citation
   * was disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Address cited elsewhere as the real Init():
   * moho/animation/IAniManipulator.h.
   */

  /**
   * `InstallMohoCBuilderArmManipulatorSerializerCallbacks` removed here
   * (2026-08-26 ArchiveSerialization audit): its `Address: 0x00636F80` citation
   * was disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Address cited elsewhere as the real Init():
   * moho/ai/CBuilderArmManipulatorSerializer.cpp,
   * moho/ai/CBuilderArmManipulatorSerializer.h.
   */

  /**
   * `InstallMohoCFootPlantManipulatorSerializerCallbacks` removed here
   * (2026-08-26 ArchiveSerialization audit): its `Address: 0x00639FA0` citation
   * was disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Address cited elsewhere as the real Init():
  ...
  /**
   * `InstallMohoCRotateManipulatorSerializerCallbacks` removed here (2026-08-26
   * ArchiveSerialization audit): its `Address: 0x00645310` citation was
   * disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Address cited elsewhere as the real Init():
   * moho/animation/CRotateManipulator.h.
   */

  /**
   * `InstallMohoCSlaveManipulatorSerializerCallbacks` removed here (2026-08-26
   * ArchiveSerialization audit): its `Address: 0x006466B0` citation was
   * disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Address cited elsewhere as the real Init():
   * moho/animation/CSlaveManipulator.h.
   */

  /**
   * `InstallMohoCSlideManipulatorSerializerCallbacks` removed here (2026-08-26
   * ArchiveSerialization audit): its `Address: 0x006484C0` citation was
   * disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Address cited elsewhere as the real Init():
   * moho/animation/CSlideManipulator.h.
   */

  /**
   * `InstallMohoCStorageManipulatorSerializerCallbacks` removed here (2026-08-26
   * ArchiveSerialization audit): its `Address: 0x00649930` citation was
   * disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Address cited elsewhere as the real Init():
   * moho/animation/CStorageManipulator.cpp.
   */

  /**
   * `InstallMohoCThrustManipulatorSerializerCallbacks` removed here (2026-08-26
   * ArchiveSerialization audit): its `Address: 0x0064B150` citation was
   * disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Address cited elsewhere as the real Init():
   * moho/animation/CThrustManipulator.cpp.
   */

  /**
   * `InstallMohoCEfxEmitterSerializerCallbacks` removed here (2026-08-26
   * ArchiveSerialization audit): its `Address: 0x0065F150` citation was
   * disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Address cited elsewhere as the real Init():
   * moho/effects/rendering/CEfxEmitterSerializer.cpp,
   * moho/effects/rendering/CEfxEmitterSerializer.h.
   */
  ...
  /**
   * `InstallMohoMotorSinkAwaySerializerCallbacks` removed here (2026-08-26
   * ArchiveSerialization audit): its `Address: 0x00696CE0` citation was
   * disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Address cited elsewhere as the real Init():
   * moho/entity/MotorSinkAway.h.
   */

  /**
   * `InstallMohoEProjectileImpactEventSerializerCallbacks` removed here
   * (2026-08-26 ArchiveSerialization audit): its `Address: 0x0069E860` citation
   * was disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Real body is
   * gpg::PrimitiveSerHelper<moho::EProjectileImpactEvent,int>::Init(),
   * instantiated in moho/projectile/ProjectileStartupRegistrations.cpp.
   */

  /**
   * `InstallMohoSInfoCacheSerializerCallbacks` removed here (2026-08-26
   * ArchiveSerialization audit): its `Address: 0x006AE810` citation was
   * disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Address cited elsewhere as the real Init():
   * moho/unit/core/SInfoCacheReflection.cpp,
   * moho/unit/core/SInfoCacheReflection.h, moho/unit/core/Unit.h.
   */

  /**
   * `InstallMohoUnitSerializerCallbacks` removed here (2026-08-26
   * ArchiveSerialization audit): its `Address: 0x006AEA20` citation was
   * disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Address cited elsewhere as the real Init():
   * moho/unit/core/UnitSerHelpers.cpp, moho/unit/core/UnitSerHelpers.h.
   */

  /**
   * `InstallMohoEUnitMotionStateSerializerCallbacks` removed here (2026-08-26
   * ArchiveSerialization audit): its `Address: 0x006BA420` citation was
   * disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Address cited elsewhere as the real Init():
   * moho/unit/UnitMotionEnumTypeInfo.cpp.
   */

  /**
   * `InstallMohoEUnitMotionCarrierEventSerializerCallbacks` removed here
   * (2026-08-26 ArchiveSerialization audit): its `Address: 0x006BA4C0` citation
   * was disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Address cited elsewhere as the real Init():
  ...
  /**
   * `InstallMohoEUnitMotionHorzEventSerializerCallbacks` removed here
   * (2026-08-26 ArchiveSerialization audit): its `Address: 0x006BA560` citation
   * was disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Address cited elsewhere as the real Init():
  ...
  /**
   * `InstallMohoEUnitMotionVertEventSerializerCallbacks` removed here
   * (2026-08-26 ArchiveSerialization audit): its `Address: 0x006BA600` citation
   * was disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Address cited elsewhere as the real Init():
  ...
  /**
   * `InstallMohoEUnitMotionTurnEventSerializerCallbacks` removed here
   * (2026-08-26 ArchiveSerialization audit): its `Address: 0x006BA6A0` citation
   * was disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Address cited elsewhere as the real Init():
  ...
  /**
   * `InstallMohoEAirCombatStateSerializerCallbacks` removed here (2026-08-26
   * ArchiveSerialization audit): its `Address: 0x006BA740` citation was
   * disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Address cited elsewhere as the real Init():
   * moho/ai/EAirCombatStateTypeInfo.h, moho/unit/UnitMotionEnumTypeInfo.cpp.
   */

  /**
   * `InstallMohoECommandEventSerializerCallbacks` removed here (2026-08-26
   * ArchiveSerialization audit): its `Address: 0x006E9760` citation was
   * disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Address cited elsewhere as the real Init():
  ...
  /**
   * `InstallMohoETriggerOperatorSerializerCallbacks` removed here (2026-08-26
   * ArchiveSerialization audit): its `Address: 0x0070E510` citation was
   * disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Real body is
   * `gpg::PrimitiveSerHelper<Moho::ETriggerOperator,int>::Init()`,
   * instantiated in moho/sim/SConditionTriggerReflection.cpp (see also the
   * per-instantiation note on `PrimitiveSerHelper` in
   * gpg/core/reflection/Reflection.h).
   */

  /**
   * `InstallMohoSConditionSerializerCallbacks` removed here (2026-08-26
   * ArchiveSerialization audit): its `Address: 0x0070E5B0` citation was
   * disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Address cited elsewhere as the real Init():
   * moho/sim/SConditionTriggerReflection.cpp.
   */

  /**
   * `InstallMohoSTriggerSerializerCallbacks` removed here (2026-08-26
   * ArchiveSerialization audit): its `Address: 0x0070E9F0` citation was
   * disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Address cited elsewhere as the real Init():
  ...
  /**
   * `InstallMohoEThreatTypeSerializerCallbacks` removed here (2026-08-26
   * ArchiveSerialization audit): its `Address: 0x00718900` citation was
   * disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Real body is
   * gpg::PrimitiveSerHelper<EThreatType,int>::Init() at the real ctor's address
   * (0x00719370 per Reflection.h); 0x00718900 is this function's own citation of
   * the Init() body belonging to the documented dead/unreachable
   * SerSaveLoadHelper<Moho::EThreatType> sibling instantiation (ctor
   * FUN_00719FF0) -- same direct-assignment shape, confirmed via raw asm, but
   * not the live path.
   */

  /**
   * `InstallMohoESquadClassSerializerCallbacks` removed here (2026-08-26
   * ArchiveSerialization audit): its `Address: 0x0072A4D0` citation was
   * disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Address cited elsewhere as the real Init():
  ...
  /**
   * `InstallMohoCEconomySerializerCallbacks` removed here (2026-08-26
   * ArchiveSerialization audit): its `Address: 0x00773D00` citation was
   * disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Address cited elsewhere as the real Init():
  ...
  /**
   * `InstallMohoCEconStorageSerializerCallbacks` removed here (2026-08-26
   * ArchiveSerialization audit): its `Address: 0x00773E20` citation was
   * disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Real body is Moho::CEconStorageSerializer::Init() (or
   * equivalent) in moho/sim/CEconStorage.cpp.
   */

  /**
   * `InstallMohoCEconRequestSerializerCallbacks` removed here (2026-08-26
   * ArchiveSerialization audit): its `Address: 0x00773F40` citation was
   * disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Address cited elsewhere as the real Init():
   * moho/misc/CEconomyEvent.cpp.
   */

  /**
   * `InstallMohoEScrollTypeSerializerCallbacks` removed here (2026-08-26
   * ArchiveSerialization audit): its `Address: 0x00777E20` citation was
   * disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Real body is
   * `gpg::PrimitiveSerHelper<Moho::EScrollType,int>::Init()`, instantiated in
   * moho/ui/EScrollTypeTypeInfo.h (see also the per-instantiation note on
   * `PrimitiveSerHelper` in gpg/core/reflection/Reflection.h). This was the
   * last live `InstallSerSaveLoadHelperCallbacksByTypeName` caller in this
   * file; see the removal note left at that dispatcher's former location
   * for the closing summary of this cleanup campaign.
   */

  /**
   * `InstallMohoSScrollerSerializerCallbacks` removed here (2026-08-26
   * ArchiveSerialization audit): its `Address: 0x00777EC0` citation was
   * disproven -- ground-truth `.c` disassembly shows the standard direct-
   * assignment `Init()` shape (`type->serLoadFunc_ = ...` / `->mSerLoadFunc =
   * ...`), not the generic by-name lookup this file modeled, and had zero
   * callers in this file. Address cited elsewhere as the real Init():
