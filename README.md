...
- Progress coverage:  **`96.52%`**
  ...
  - *Total amount of completed tokens: `64,831`*

Progress DB status breakdown:

- `recovered`: `52,944` (81.66%)
...
### Recovered (52,944 functions) — wiring health
...
| Caller still blocked (orphan-helper risk — caller awaits recovery) | `2,892` | 5.46% |
