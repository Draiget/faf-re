...
- Progress coverage:  **`96.43%`**
  ...
  - *Total amount of completed tokens: `64,768`*

Progress DB status breakdown:

- `recovered`: `52,881` (81.65%)
...
### Recovered (52,881 functions) — wiring health

| Bucket | Count | % of recovered |
|---|---:|---:|
| **Confirmed caller** (recovered binary caller wired by name) | `14,725` | 27.85% |
