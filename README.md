...
### Recovered (53,342 functions) — binary caller context

| Bucket | Count | % of recovered |
|---|---:|---:|
| **Recovered caller token exists** (source edge still requires verification) | `16,343` | 30.64% |
...
| No recovered caller token yet (orphan risk) | `2,183` | 4.09% |
