...
- `recovered`: `53,055` (79.73%)
- `skip`: `7,721` (11.60%) — proven ICF aliases / thunks / EH or static-init glue with no distinct source body
...
### Recovered (53,055 functions) — binary caller context

| Bucket | Count | % of recovered |
|---|---:|---:|
| **Recovered caller token exists** (source edge still requires verification) | `17,093` | 32.22% |
| Vtable-anchored (virtual override of a recovered class) | `5,884` | 11.09% |
...
| No callsite evidence (no recorded code/data caller in the index) | `22,583` | 42.57% |
