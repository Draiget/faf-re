...
- Progress coverage:  **`99.19%`**
  ...
  - *Total amount of completed tokens: `66,625`*

Progress DB status breakdown:

- `recovered`: `52,769` (79.20%)
...
|---|---:|---:|
| **Recovered caller token exists** (source edge still requires verification) | `17,168` | 32.53% |
...
| No callsite evidence (no recorded code/data caller in the index) | `22,222` | 42.11% |
