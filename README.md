...
- `recovered`: `53,172` (79.91%)
- `skip`: `7,601` (11.42%) — proven ICF aliases / thunks / EH or static-init glue with no distinct source body
...
### Recovered (53,172 functions) — binary caller context

| Bucket | Count | % of recovered |
|---|---:|---:|
| **Recovered caller token exists** (source edge still requires verification) | `17,093` | 32.15% |
| Vtable-anchored (virtual override of a recovered class) | `5,882` | 11.06% |
...
| No callsite evidence (no recorded code/data caller in the index) | `22,703` | 42.70% |
