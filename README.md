...
### Recovered (53,100 functions) — binary caller context
...
| No recovered caller token yet (orphan risk) | `1,750` | 3.30% |
| No callsite evidence (no recorded code/data caller in the index) | `22,873` | 43.08% |
