...
- Progress coverage:  **`96.50%`**
  ...
  - *Total amount of completed tokens: `64,816`*

Progress DB status breakdown:

- `recovered`: `52,929` (81.66%)
...
### Recovered (52,929 functions) — wiring health

| Bucket | Count | % of recovered |
|---|---:|---:|
| **Confirmed caller** (recovered binary caller wired by name) | `14,796` | 27.95% |
