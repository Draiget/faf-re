...
- Progress coverage:  **`96.41%`**
  ...
  - *Total amount of completed tokens: `64,759`*

Progress DB status breakdown:

- `recovered`: `52,872` (81.64%)
...
### Recovered (52,872 functions) — wiring health

| Bucket | Count | % of recovered |
|---|---:|---:|
| **Confirmed caller** (recovered binary caller wired by name) | `14,711` | 27.82% |
...
| Caller still blocked (orphan-helper risk — caller awaits recovery) | `2,928` | 5.54% |
