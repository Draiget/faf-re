...
- Progress coverage:  **`96.43%`**
  ...
  - *Total amount of completed tokens: `64,769`*

Progress DB status breakdown:

- `recovered`: `52,708` (81.38%)
...
|---|---:|---:|
| **Recovered caller token exists** (source edge still requires verification) | `16,344` | 31.01% |
