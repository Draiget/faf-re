...
### Recovered (52,909 functions) — binary caller context

| Bucket | Count | % of recovered |
|---|---:|---:|
| **Recovered caller token exists** (source edge still requires verification) | `16,520` | 31.22% |
...
| No recovered caller token yet (orphan risk) | `1,847` | 3.49% |
