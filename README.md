...
## Recovery Coverage (`19/06/2026`, `fa_full_2026_03_26`)
...
- Progress coverage:  **`96.65%`**
  ...
  - *Total amount of completed tokens: `64,917`*

Progress DB status breakdown:

- `recovered`: `53,030` (81.69%)
...
### Recovered (53,030 functions) — wiring health

| Bucket | Count | % of recovered |
|---|---:|---:|
| **Confirmed caller** (recovered binary caller wired by name) | `14,942` | 28.18% |
...
|---|---:|---:|
| **Recoverable now** (`OK_RECOVERED_CALLER` — recovered caller exists; recover next) | `496` | 21.71% |
| Vtable-anchored (recover with the owning class) | `232` | 10.15% |
| Framework dispatch (wx/EH/Lua/reflection) | `35` | 1.53% |
| **Caller functions unrecovered** (`NEEDS_RECOVERED_CALLER` — recover the parent first) | `1,071` | 46.87% |
| No callsite evidence (likely external/dead — candidates for `external_dependency`) | `449` | 19.65% |
