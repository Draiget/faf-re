...
- Progress coverage:  **`96.50%`**
  ...
  - *Total amount of completed tokens: `64,815`*

Progress DB status breakdown:

- `recovered`: `52,928` (81.66%)
...
### Recovered (52,928 functions) — wiring health

| Bucket | Count | % of recovered |
|---|---:|---:|
| **Confirmed caller** (recovered binary caller wired by name) | `14,794` | 27.95% |
