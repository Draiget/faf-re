...
- Progress coverage:  **`97.84%`**
  ...
  - *Total amount of completed tokens: `65,714`*

Progress DB status breakdown:

- `recovered`: `53,048` (80.73%)
- `skip`: `7,119` (10.83%) — proven ICF aliases / thunks / EH or static-init glue with no distinct source body
...
| **Caller functions unrecovered** (`NEEDS_RECOVERED_CALLER` — recover the parent first) | `714` | 47.10% |
| No indexed callsite evidence (needs investigation/evidence) | `597` | 39.38% |
