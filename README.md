...
|---|---:|---:|
| **Recovered caller token exists** (source edge still requires verification) | `16,625` | 31.00% |
...
|---|---:|---:|
| **Candidate** (`OK_RECOVERED_CALLER` — caller token recovered; inspect its body) | `298` | 14.40% |
| Vtable-anchored (recover with the owning class) | `111` | 5.36% |
| Framework dispatch (wx/EH/Lua/reflection) | `1` | 0.05% |
| **Caller functions unrecovered** (`NEEDS_RECOVERED_CALLER` — recover the parent first) | `722` | 34.88% |
| No indexed callsite evidence (needs investigation/evidence) | `936` | 45.22% |
