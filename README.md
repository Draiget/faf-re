...
- Progress coverage:  **`97.38%`**
  ...
  - *Total amount of completed tokens: `65,410`*

Progress DB status breakdown:

- `recovered`: `53,777` (82.22%)
...
### Recovered (53,777 functions) — binary caller context

| Bucket | Count | % of recovered |
|---|---:|---:|
| **Recovered caller token exists** (source edge still requires verification) | `16,024` | 29.80% |
...
|---|---:|---:|
| **Candidate** (`OK_RECOVERED_CALLER` — caller token recovered; inspect its body) | `274` | 15.10% |
| Vtable-anchored (recover with the owning class) | `173` | 9.54% |
| Framework dispatch (wx/EH/Lua/reflection) | `1` | 0.06% |
| **Caller functions unrecovered** (`NEEDS_RECOVERED_CALLER` — recover the parent first) | `905` | 49.89% |
| No indexed callsite evidence (needs investigation/evidence) | `458` | 25.25% |
