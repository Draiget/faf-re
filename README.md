...
### Recovered (53,747 functions) — binary caller context

| Bucket | Count | % of recovered |
|---|---:|---:|
| **Recovered caller token exists** (source edge still requires verification) | `16,015` | 29.80% |
...
| No recovered caller token yet (orphan risk) | `2,410` | 4.48% |
