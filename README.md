...
- Progress coverage:  **`96.44%`**
  ...
  - *Total amount of completed tokens: `64,776`*

Progress DB status breakdown:

- `recovered`: `52,889` (81.65%)
...
### Recovered (52,889 functions) — wiring health

| Bucket | Count | % of recovered |
|---|---:|---:|
| **Confirmed caller** (recovered binary caller wired by name) | `14,736` | 27.86% |
...
| Caller still blocked (orphan-helper risk — caller awaits recovery) | `2,920` | 5.52% |
