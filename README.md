...
### Recovered (52,820 functions) — binary caller context

| Bucket | Count | % of recovered |
|---|---:|---:|
| **Recovered caller token exists** (source edge still requires verification) | `17,183` | 32.53% |
...
| No recovered caller token yet (orphan risk) | `1,646` | 3.12% |
