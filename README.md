...
- `recovered`: `53,256` (80.04%)
- `skip`: `7,514` (11.29%) — proven ICF aliases / thunks / EH or static-init glue with no distinct source body
...
| No callsite evidence (no recorded code/data caller in the index) | `22,792` | 42.80% |
