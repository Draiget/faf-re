...
- `recovered`: `52,755` (79.18%)
- `skip`: `8,113` (12.18%) — proven ICF aliases / thunks / EH or static-init glue with no distinct source body
...
|---|---:|---:|
| **Recovered caller token exists** (source edge still requires verification) | `17,156` | 32.52% |
| Vtable-anchored (virtual override of a recovered class) | `5,888` | 11.16% |
| Framework dispatch (wx event, EH handler, Lua binding, reflection table, …) | `5,596` | 10.61% |
| No recovered caller token yet (orphan risk) | `1,671` | 3.17% |
| No callsite evidence (no recorded code/data caller in the index) | `22,224` | 42.13% |
