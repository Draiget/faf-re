...
|---|---:|---:|
| **Candidate** (`OK_RECOVERED_CALLER` — caller token recovered; inspect its body) | `314` | 16.11% |
| Vtable-anchored (recover with the owning class) | `193` | 9.90% |
| Framework dispatch (wx/EH/Lua/reflection) | `56` | 2.87% |
| **Caller functions unrecovered** (`NEEDS_RECOVERED_CALLER` — recover the parent first) | `921` | 47.26% |
