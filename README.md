...
- `recovered`: `52,921` (79.53%)
- `skip`: `7,859` (11.81%) — proven ICF aliases / thunks / EH or static-init glue with no distinct source body
...
### Recovered (52,921 functions) — binary caller context
...
| Framework dispatch (wx event, EH handler, Lua binding, reflection table, …) | `5,585` | 10.55% |
| No recovered caller token yet (orphan risk) | `1,697` | 3.21% |
| No callsite evidence (no recorded code/data caller in the index) | `22,438` | 42.40% |
