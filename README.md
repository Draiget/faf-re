...
### Recovered (52,808 functions) — binary caller context
...
| No recovered caller token yet (orphan risk) | `1,642` | 3.11% |
| No callsite evidence (no recorded code/data caller in the index) | `22,251` | 42.14% |
