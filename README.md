...
- `recovered`: `53,208` (79.96%)
- `skip`: `7,562` (11.36%) — proven ICF aliases / thunks / EH or static-init glue with no distinct source body
...
|---|---:|---:|
| **Recovered caller token exists** (source edge still requires verification) | `17,093` | 32.12% |
| Vtable-anchored (virtual override of a recovered class) | `5,882` | 11.05% |
| Framework dispatch (wx event, EH handler, Lua binding, reflection table, …) | `5,573` | 10.47% |
| No recovered caller token yet (orphan risk) | `1,697` | 3.19% |
| No callsite evidence (no recorded code/data caller in the index) | `22,743` | 42.74% |
