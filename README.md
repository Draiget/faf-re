...
### Recovered (53,597 functions) — binary caller context

| Bucket | Count | % of recovered |
|---|---:|---:|
| **Recovered caller token exists** (source edge still requires verification) | `15,817` | 29.51% |
| Vtable-anchored (virtual override of a recovered class) | `5,843` | 10.90% |
| Framework dispatch (wx event, EH handler, Lua binding, reflection table, …) | `5,536` | 10.33% |
| No recovered caller token yet (orphan risk) | `2,467` | 4.60% |
| No callsite evidence (no recorded code/data caller in the index) | `23,714` | 44.25% |
