...
### Recovered (52,828 functions) — binary caller context

| Bucket | Count | % of recovered |
|---|---:|---:|
| **Recovered caller token exists** (source edge still requires verification) | `17,238` | 32.63% |
...
| No recovered caller token yet (orphan risk) | `1,601` | 3.03% |
| No callsite evidence (no recorded code/data caller in the index) | `22,259` | 42.13% |
