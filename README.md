...
- Progress coverage:  **`96.53%`**
  ...
  - *Total amount of completed tokens: `64,834`*

Progress DB status breakdown:

- `recovered`: `52,947` (81.67%)
...
### Recovered (52,947 functions) — wiring health

| Bucket | Count | % of recovered |
|---|---:|---:|
| **Confirmed caller** (recovered binary caller wired by name) | `14,823` | 28.00% |
