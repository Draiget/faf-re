...
|---|---:|---:|
| **Candidate** (`OK_RECOVERED_CALLER` — caller token recovered; inspect its body) | `306` | 14.11% |
| Vtable-anchored (recover with the owning class) | `113` | 5.21% |
| Framework dispatch (wx/EH/Lua/reflection) | `1` | 0.05% |
| **Caller functions unrecovered** (`NEEDS_RECOVERED_CALLER` — recover the parent first) | `762` | 35.15% |
| No indexed callsite evidence (needs investigation/evidence) | `984` | 45.39% |
