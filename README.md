...
|---|---:|---:|
| **Recovered caller token exists** (source edge still requires verification) | `16,128` | 30.37% |
...
| No recovered caller token yet (orphan risk) | `2,270` | 4.27% |
...
| Framework dispatch (wx/EH/Lua/reflection) | `67` | 2.66% |
| **Caller functions unrecovered** (`NEEDS_RECOVERED_CALLER` — recover the parent first) | `840` | 33.40% |
| No indexed callsite evidence (needs investigation/evidence) | `987` | 39.24% |
