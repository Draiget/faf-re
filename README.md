...
- `recovered`: `52,765` (79.20%)
- `skip`: `8,103` (12.16%) — proven ICF aliases / thunks / EH or static-init glue with no distinct source body
...
| No callsite evidence (no recorded code/data caller in the index) | `22,234` | 42.14% |
