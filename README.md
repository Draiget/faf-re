...
- Progress coverage:  **`96.52%`**
  ...
  - *Total amount of completed tokens: `64,827`*

Progress DB status breakdown:

- `recovered`: `52,940` (81.66%)
...
### Recovered (52,940 functions) — wiring health

| Bucket | Count | % of recovered |
|---|---:|---:|
| **Confirmed caller** (recovered binary caller wired by name) | `14,813` | 27.98% |
