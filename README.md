...
### Recovered (53,767 functions) — binary caller context

| Bucket | Count | % of recovered |
|---|---:|---:|
| **Recovered caller token exists** (source edge still requires verification) | `16,134` | 30.01% |
| Vtable-anchored (virtual override of a recovered class) | `5,850` | 10.88% |
...
|---|---:|---:|
| **Candidate** (`OK_RECOVERED_CALLER` — caller token recovered; inspect its body) | `308` | 16.64% |
| Vtable-anchored (recover with the owning class) | `168` | 9.08% |
| Framework dispatch (wx/EH/Lua/reflection) | `54` | 2.92% |
| **Caller functions unrecovered** (`NEEDS_RECOVERED_CALLER` — recover the parent first) | `858` | 46.35% |
| No indexed callsite evidence (needs investigation/evidence) | `459` | 24.80% |
