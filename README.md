...
- `recovered`: `52,760` (79.00%)
- `skip`: `8,285` (12.41%) — proven ICF aliases / thunks / EH or static-init glue with no distinct source body
...
|---|---:|---:|
| **Recovered caller token exists** (source edge still requires verification) | `17,174` | 32.55% |
| Vtable-anchored (virtual override of a recovered class) | `5,892` | 11.17% |
| Framework dispatch (wx event, EH handler, Lua binding, reflection table, …) | `5,625` | 10.66% |
| No recovered caller token yet (orphan risk) | `1,649` | 3.13% |
| No callsite evidence (no recorded code/data caller in the index) | `22,200` | 42.08% |
