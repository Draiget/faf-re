...
### Recovered (52,815 functions) — binary caller context
...
|---|---:|---:|
| **Candidate** (`OK_RECOVERED_CALLER` — caller token recovered; inspect its body) | `233` | 12.84% |
| Vtable-anchored (recover with the owning class) | `131` | 7.22% |
| Framework dispatch (wx/EH/Lua/reflection) | `8` | 0.44% |
| **Caller functions unrecovered** (`NEEDS_RECOVERED_CALLER` — recover the parent first) | `832` | 45.87% |
| No indexed callsite evidence (needs investigation/evidence) | `608` | 33.52% |
