...
- `recovered`: `52,749` (81.88%)
- `skip`: `6,249` (9.70%) — proven ICF aliases / thunks / EH or static-init glue with no distinct source body
...
|---|---:|---:|
| **Recovered caller token exists** (source edge still requires verification) | `16,319` | 30.94% |
...
| No callsite evidence (no recorded code/data caller in the index) | `22,913` | 43.44% |
...
|---|---:|---:|
| **Candidate** (`OK_RECOVERED_CALLER` — caller token recovered; inspect its body) | `372` | 13.21% |
...
| No indexed callsite evidence (needs investigation/evidence) | `1,248` | 44.33% |
