...
- Progress coverage:  **`99.06%`**
  ...
  - *Total amount of completed tokens: `66,533`*

Progress DB status breakdown:

- `recovered`: `53,369` (80.21%)
...
### Recovered (53,369 functions) — binary caller context
...
| No callsite evidence (no recorded code/data caller in the index) | `22,919` | 42.94% |
