...
### Recovered (53,667 functions) — binary caller context

| Bucket | Count | % of recovered |
|---|---:|---:|
| **Recovered caller token exists** (source edge still requires verification) | `15,889` | 29.61% |
...
| No callsite evidence (no recorded code/data caller in the index) | `23,716` | 44.19% |
