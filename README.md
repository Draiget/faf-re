...
## Recovery Coverage (`06/08/2026`, `fa_full_2026_03_26`)
...
### Recovered (53,735 functions) — binary caller context

| Bucket | Count | % of recovered |
|---|---:|---:|
| **Recovered caller token exists** (source edge still requires verification) | `15,990` | 29.76% |
...
| No recovered caller token yet (orphan risk) | `2,425` | 4.51% |
| No callsite evidence (no recorded code/data caller in the index) | `23,718` | 44.14% |
