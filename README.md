...
- Progress coverage:  **`97.21%`**
  ...
  - *Total amount of completed tokens: `65,292`*

Progress DB status breakdown:

- `recovered`: `53,685` (82.22%)
...
### Recovered (53,685 functions) — binary caller context
...
|---|---:|---:|
| **Candidate** (`OK_RECOVERED_CALLER` — caller token recovered; inspect its body) | `311` | 16.10% |
| Vtable-anchored (recover with the owning class) | `189` | 9.78% |
| Framework dispatch (wx/EH/Lua/reflection) | `56` | 2.90% |
| **Caller functions unrecovered** (`NEEDS_RECOVERED_CALLER` — recover the parent first) | `911` | 47.15% |
| No indexed callsite evidence (needs investigation/evidence) | `461` | 23.86% |
