...
### Recovered (53,123 functions) — binary caller context

| Bucket | Count | % of recovered |
|---|---:|---:|
| **Recovered caller token exists** (source edge still requires verification) | `16,833` | 31.69% |
...
| No recovered caller token yet (orphan risk) | `1,744` | 3.28% |
