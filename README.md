...
- `external_dependency`: `5,546` (8.46%) — proven third-party/import-boundary code
...
|---|---:|---:|
| **Candidate** (`OK_RECOVERED_CALLER` — caller token recovered; inspect its body) | `154` | 9.35% |
| Vtable-anchored (recover with the owning class) | `129` | 7.83% |
| Framework dispatch (wx/EH/Lua/reflection) | `8` | 0.49% |
| **Caller functions unrecovered** (`NEEDS_RECOVERED_CALLER` — recover the parent first) | `756` | 45.90% |
| No indexed callsite evidence (needs investigation/evidence) | `599` | 36.37% |
