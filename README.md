...
- Progress coverage:  **`97.38%`**
  ...
  - *Total amount of completed tokens: `65,406`*

Progress DB status breakdown:

- `recovered`: `53,773` (82.21%)
...
### Recovered (53,773 functions) — binary caller context
...
| **Caller functions unrecovered** (`NEEDS_RECOVERED_CALLER` — recover the parent first) | `908` | 49.94% |
| No indexed callsite evidence (needs investigation/evidence) | `458` | 25.19% |
