...
- `recovered`: `52,731` (81.81%)
- `skip`: `6,292` (9.76%) — proven ICF aliases / thunks / EH or static-init glue with no distinct source body
...
### Recovered (52,731 functions) — binary caller context

| Bucket | Count | % of recovered |
|---|---:|---:|
| **Recovered caller token exists** (source edge still requires verification) | `16,332` | 30.97% |
...
| No recovered caller token yet (orphan risk) | `1,848` | 3.50% |
