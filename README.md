...
- Progress coverage:  **`96.33%`**
  ...
  - *Total amount of completed tokens: `64,705`*

Progress DB status breakdown:

- `recovered`: `53,090` (82.05%)
...
|---|---:|---:|
| **Recovered caller token exists** (source edge still requires verification) | `16,110` | 30.34% |
...
| No callsite evidence (no recorded code/data caller in the index) | `23,182` | 43.67% |
