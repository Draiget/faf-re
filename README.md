...
- `recovered`: `53,707` (82.23%)
- `skip`: `6,112` (9.36%) — proven ICF aliases / thunks / EH or static-init glue with no distinct source body
...
### Recovered (53,707 functions) — binary caller context

| Bucket | Count | % of recovered |
|---|---:|---:|
| **Recovered caller token exists** (source edge still requires verification) | `16,028` | 29.84% |
...
| No recovered caller token yet (orphan risk) | `2,398` | 4.46% |
