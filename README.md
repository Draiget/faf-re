...
## Recovery Coverage (`03/08/2026`, `fa_full_2026_03_26`)
...
|---|---:|---:|
| **Recovered caller token exists** (source edge still requires verification) | `15,964` | 29.72% |
| Vtable-anchored (virtual override of a recovered class) | `5,840` | 10.87% |
| Framework dispatch (wx event, EH handler, Lua binding, reflection table, …) | `5,542` | 10.32% |
| No recovered caller token yet (orphan risk) | `2,427` | 4.52% |
| No callsite evidence (no recorded code/data caller in the index) | `23,718` | 44.16% |
