...
- `recovered`: `52,785` (79.04%)
- `skip`: `8,260` (12.37%) — proven ICF aliases / thunks / EH or static-init glue with no distinct source body
...
### Recovered (52,785 functions) — binary caller context

| Bucket | Count | % of recovered |
|---|---:|---:|
| **Recovered caller token exists** (source edge still requires verification) | `17,174` | 32.54% |
...
| No recovered caller token yet (orphan risk) | `1,649` | 3.12% |
| No callsite evidence (no recorded code/data caller in the index) | `22,225` | 42.10% |
