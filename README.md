...
- `recovered`: `53,299` (80.10%)
- `skip`: `7,471` (11.23%) — proven ICF aliases / thunks / EH or static-init glue with no distinct source body
...
### Recovered (53,299 functions) — binary caller context
...
| Framework dispatch (wx event, EH handler, Lua binding, reflection table, …) | `5,572` | 10.45% |
| No recovered caller token yet (orphan risk) | `1,697` | 3.18% |
| No callsite evidence (no recorded code/data caller in the index) | `22,835` | 42.84% |
