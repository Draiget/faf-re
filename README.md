...
- `recovered`: `52,813` (79.08%)
- `skip`: `8,232` (12.33%) — proven ICF aliases / thunks / EH or static-init glue with no distinct source body
...
|---|---:|---:|
| **Recovered caller token exists** (source edge still requires verification) | `17,174` | 32.52% |
| Vtable-anchored (virtual override of a recovered class) | `5,892` | 11.16% |
| Framework dispatch (wx event, EH handler, Lua binding, reflection table, …) | `5,630` | 10.66% |
