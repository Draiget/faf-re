...
### Recovered (53,103 functions) — binary caller context

| Bucket | Count | % of recovered |
|---|---:|---:|
| **Recovered caller token exists** (source edge still requires verification) | `16,808` | 31.65% |
...
### Not-yet-recovered (1,057 blocked + needs_evidence) — backlog readiness

| Bucket | Count | % of backlog |
|---|---:|---:|
| **Candidate** (`OK_RECOVERED_CALLER` — caller token recovered; inspect its body) | `39` | 3.69% |
| Vtable-anchored (recover with the owning class) | `120` | 11.35% |
| Framework dispatch (wx/EH/Lua/reflection) | `8` | 0.76% |
| **Caller functions unrecovered** (`NEEDS_RECOVERED_CALLER` — recover the parent first) | `523` | 49.48% |
| No indexed callsite evidence (needs investigation/evidence) | `366` | 34.63% |
