...
|---|---:|---:|
| **Recovered caller token exists** (source edge still requires verification) | `16,315` | 30.93% |
...
|---|---:|---:|
| **Candidate** (`OK_RECOVERED_CALLER` — caller token recovered; inspect its body) | `376` | 13.34% |
...
| No indexed callsite evidence (needs investigation/evidence) | `1,248` | 44.27% |
