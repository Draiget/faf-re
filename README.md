...
- `recovered`: `52,920` (79.53%)
- `skip`: `7,860` (11.81%) — proven ICF aliases / thunks / EH or static-init glue with no distinct source body
...
### Recovered (52,920 functions) — binary caller context
...
| Framework dispatch (wx event, EH handler, Lua binding, reflection table, …) | `5,586` | 10.56% |
| No recovered caller token yet (orphan risk) | `1,697` | 3.21% |
| No callsite evidence (no recorded code/data caller in the index) | `22,436` | 42.40% |
