...
- Progress coverage:  **`99.07%`**
  ...
  - *Total amount of completed tokens: `66,543`*

Progress DB status breakdown:

- `recovered`: `52,943` (79.56%)
- `skip`: `7,834` (11.77%) — proven ICF aliases / thunks / EH or static-init glue with no distinct source body
...
### Recovered (52,943 functions) — binary caller context

| Bucket | Count | % of recovered |
|---|---:|---:|
| **Recovered caller token exists** (source edge still requires verification) | `17,093` | 32.29% |
| Vtable-anchored (virtual override of a recovered class) | `5,887` | 11.12% |
...
| No callsite evidence (no recorded code/data caller in the index) | `22,465` | 42.43% |
