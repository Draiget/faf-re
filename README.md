...
|---|---:|---:|
| **Recovered caller token exists** (source edge still requires verification) | `16,147` | 30.09% |
...
| No recovered caller token yet (orphan risk) | `2,260` | 4.21% |
...
|---|---:|---:|
| **Candidate** (`OK_RECOVERED_CALLER` — caller token recovered; inspect its body) | `390` | 20.00% |
| Vtable-anchored (recover with the owning class) | `179` | 9.18% |
| Framework dispatch (wx/EH/Lua/reflection) | `64` | 3.28% |
| **Caller functions unrecovered** (`NEEDS_RECOVERED_CALLER` — recover the parent first) | `848` | 43.49% |
| No indexed callsite evidence (needs investigation/evidence) | `465` | 23.85% |
