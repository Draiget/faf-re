...
- `recovered`: `52,962` (79.59%)
- `skip`: `7,815` (11.74%) — proven ICF aliases / thunks / EH or static-init glue with no distinct source body
...
### Recovered (52,962 functions) — binary caller context

| Bucket | Count | % of recovered |
|---|---:|---:|
| **Recovered caller token exists** (source edge still requires verification) | `17,093` | 32.27% |
...
| No callsite evidence (no recorded code/data caller in the index) | `22,484` | 42.45% |
