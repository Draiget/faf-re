...
- Progress coverage:  **`96.76%`**
  ...
  - *Total amount of completed tokens: `64,990`*

Progress DB status breakdown:

- `recovered`: `53,109` (81.72%)
...
### Recovered (53,109 functions) — wiring health

| Bucket | Count | % of recovered |
|---|---:|---:|
| **Confirmed caller** (recovered binary caller wired by name) | `14,997` | 28.24% |
