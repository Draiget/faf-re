...
- `recovered`: `53,439` (81.81%)
- `skip`: `6,117` (9.36%) — CRT-internal / compiler-generated / orphan template instantiations / static-init glue
...
### Recovered (53,439 functions) — wiring health
...
| No callsite evidence (no recorded code/data caller in the index) | `23,748` | 44.44% |
