...
|---|---:|---:|
| **Recovered caller token exists** (source edge still requires verification) | `15,987` | 29.79% |
...
| No recovered caller token yet (orphan risk) | `2,408` | 4.49% |
...
|---|---:|---:|
| **Candidate** (`OK_RECOVERED_CALLER` — caller token recovered; inspect its body) | `313` | 16.09% |
| Vtable-anchored (recover with the owning class) | `193` | 9.92% |
| Framework dispatch (wx/EH/Lua/reflection) | `56` | 2.88% |
| **Caller functions unrecovered** (`NEEDS_RECOVERED_CALLER` — recover the parent first) | `918` | 47.20% |
| No indexed callsite evidence (needs investigation/evidence) | `461` | 23.70% |
