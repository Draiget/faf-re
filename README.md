...
|---|---:|---:|
| **Recovered caller token exists** (source edge still requires verification) | `16,491` | 30.79% |
...
|---|---:|---:|
| **Candidate** (`OK_RECOVERED_CALLER` — caller token recovered; inspect its body) | `324` | 15.20% |
| Vtable-anchored (recover with the owning class) | `117` | 5.49% |
| Framework dispatch (wx/EH/Lua/reflection) | `1` | 0.05% |
| **Caller functions unrecovered** (`NEEDS_RECOVERED_CALLER` — recover the parent first) | `775` | 36.37% |
| No indexed callsite evidence (needs investigation/evidence) | `912` | 42.80% |
