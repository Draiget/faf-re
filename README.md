...
### Recovered (53,628 functions) — binary caller context

| Bucket | Count | % of recovered |
|---|---:|---:|
| **Recovered caller token exists** (source edge still requires verification) | `15,857` | 29.57% |
...
| No recovered caller token yet (orphan risk) | `2,452` | 4.57% |
