...
- Progress coverage:  **`96.51%`**
  ...
  - *Total amount of completed tokens: `64,823`*

Progress DB status breakdown:

- `recovered`: `52,936` (81.66%)
...
### Recovered (52,936 functions) — wiring health

| Bucket | Count | % of recovered |
|---|---:|---:|
| **Confirmed caller** (recovered binary caller wired by name) | `14,805` | 27.97% |
...
| Caller still blocked (orphan-helper risk — caller awaits recovery) | `2,897` | 5.47% |
