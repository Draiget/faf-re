...
- Progress coverage:  **`97.63%`**
  ...
  - *Total amount of completed tokens: `65,576`*
...
|---|---:|---:|
| **Candidate** (`OK_RECOVERED_CALLER` — caller token recovered; inspect its body) | `156` | 9.44% |
| Vtable-anchored (recover with the owning class) | `129` | 7.80% |
| Framework dispatch (wx/EH/Lua/reflection) | `8` | 0.48% |
| **Caller functions unrecovered** (`NEEDS_RECOVERED_CALLER` — recover the parent first) | `760` | 45.98% |
| No indexed callsite evidence (needs investigation/evidence) | `599` | 36.24% |
