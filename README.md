...
- `recovered`: `53,246` (80.02%)
- `skip`: `7,524` (11.31%) — proven ICF aliases / thunks / EH or static-init glue with no distinct source body
...
|---|---:|---:|
| **Recovered caller token exists** (source edge still requires verification) | `17,093` | 32.10% |
...
| No callsite evidence (no recorded code/data caller in the index) | `22,782` | 42.79% |
