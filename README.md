...
### Recovered (53,449 functions) — binary caller context
...
|---|---:|---:|
| **Candidate** (`OK_RECOVERED_CALLER` — caller token recovered; inspect its body) | `347` | 15.90% |
| Vtable-anchored (recover with the owning class) | `127` | 5.82% |
| Framework dispatch (wx/EH/Lua/reflection) | `16` | 0.73% |
| **Caller functions unrecovered** (`NEEDS_RECOVERED_CALLER` — recover the parent first) | `771` | 35.32% |
| No indexed callsite evidence (needs investigation/evidence) | `919` | 42.10% |
