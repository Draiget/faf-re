...
- `recovered`: `52,968` (79.60%)
- `skip`: `7,809` (11.74%) — proven ICF aliases / thunks / EH or static-init glue with no distinct source body
...
### Recovered (52,968 functions) — binary caller context

| Bucket | Count | % of recovered |
|---|---:|---:|
| **Recovered caller token exists** (source edge still requires verification) | `17,093` | 32.27% |
| Vtable-anchored (virtual override of a recovered class) | `5,887` | 11.11% |
...
| No callsite evidence (no recorded code/data caller in the index) | `22,490` | 42.46% |
