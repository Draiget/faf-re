...
- Progress coverage:  **`96.74%`**
  ...
  - *Total amount of completed tokens: `64,977`*

Progress DB status breakdown:

- `recovered`: `52,747` (81.18%)
- `skip`: `6,722` (10.35%) — proven ICF aliases / thunks / EH or static-init glue with no distinct source body
- `external_dependency`: `5,508` (8.48%) — proven third-party/import-boundary code
...
### Recovered (52,747 functions) — binary caller context

| Bucket | Count | % of recovered |
|---|---:|---:|
| **Recovered caller token exists** (source edge still requires verification) | `16,370` | 31.03% |
...
| No callsite evidence (no recorded code/data caller in the index) | `22,853` | 43.33% |
