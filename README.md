...
- Progress coverage:  **`97.63%`**
  ...
  - *Total amount of completed tokens: `65,572`*
...
- `external_dependency`: `5,536` (8.44%) — proven third-party/import-boundary code
...
|---|---:|---:|
| **Candidate** (`OK_RECOVERED_CALLER` — caller token recovered; inspect its body) | `156` | 9.41% |
| Vtable-anchored (recover with the owning class) | `129` | 7.79% |
| Framework dispatch (wx/EH/Lua/reflection) | `8` | 0.48% |
| **Caller functions unrecovered** (`NEEDS_RECOVERED_CALLER` — recover the parent first) | `764` | 46.11% |
| No indexed callsite evidence (needs investigation/evidence) | `599` | 36.15% |
