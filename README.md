...
- `recovered`: `53,258` (80.04%)
- `skip`: `7,512` (11.29%) — proven ICF aliases / thunks / EH or static-init glue with no distinct source body
...
|---|---:|---:|
| **Recovered caller token exists** (source edge still requires verification) | `17,093` | 32.09% |
...
| No callsite evidence (no recorded code/data caller in the index) | `22,794` | 42.80% |
