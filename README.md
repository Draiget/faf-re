...
- `recovered`: `52,767` (79.20%)
- `skip`: `8,114` (12.18%) — proven ICF aliases / thunks / EH or static-init glue with no distinct source body
...
|---|---:|---:|
| **Recovered caller token exists** (source edge still requires verification) | `17,167` | 32.53% |
| Vtable-anchored (virtual override of a recovered class) | `5,888` | 11.16% |
| Framework dispatch (wx event, EH handler, Lua binding, reflection table, …) | `5,601` | 10.61% |
| No recovered caller token yet (orphan risk) | `1,670` | 3.16% |
| No callsite evidence (no recorded code/data caller in the index) | `22,221` | 42.11% |
