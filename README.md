...
- Progress coverage:  **`96.44%`**
  ...
  - *Total amount of completed tokens: `64,775`*

Progress DB status breakdown:

- `recovered`: `52,888` (81.65%)
...
### Recovered (52,888 functions) — wiring health

| Bucket | Count | % of recovered |
|---|---:|---:|
| **Confirmed caller** (recovered binary caller wired by name) | `14,735` | 27.86% |
