...
- `recovered`: `53,071` (81.71%)
- `skip`: `6,095` (9.38%) — CRT-internal / compiler-generated / orphan template instantiations / static-init glue
...
### Recovered (53,071 functions) — wiring health
...
| No callsite evidence (no recorded code/data caller in the index) | `23,743` | 44.74% |
...
|---|---:|---:|
| **Recoverable now** (`OK_RECOVERED_CALLER` — recovered caller exists; recover next) | `487` | 21.65% |
| Vtable-anchored (recover with the owning class) | `216` | 9.60% |
| Framework dispatch (wx/EH/Lua/reflection) | `35` | 1.56% |
| **Caller functions unrecovered** (`NEEDS_RECOVERED_CALLER` — recover the parent first) | `1,066` | 47.40% |
| No callsite evidence (likely external/dead — candidates for `external_dependency`) | `443` | 19.70% |
