...
|---|---:|---:|
| **Recovered caller token exists** (source edge still requires verification) | `15,984` | 29.74% |
...
| No recovered caller token yet (orphan risk) | `2,435` | 4.53% |
