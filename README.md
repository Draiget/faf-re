...
- `recovered`: `52,919` (79.52%)
- `skip`: `7,861` (11.81%) — proven ICF aliases / thunks / EH or static-init glue with no distinct source body
...
### Recovered (52,919 functions) — binary caller context
...
| Framework dispatch (wx event, EH handler, Lua binding, reflection table, …) | `5,584` | 10.55% |
| No recovered caller token yet (orphan risk) | `1,697` | 3.21% |
| No callsite evidence (no recorded code/data caller in the index) | `22,437` | 42.40% |
