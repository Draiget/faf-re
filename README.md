...
### Recovered (52,802 functions) — binary caller context
...
|---|---:|---:|
| **Candidate** (`OK_RECOVERED_CALLER` — caller token recovered; inspect its body) | `236` | 12.87% |
| Vtable-anchored (recover with the owning class) | `131` | 7.14% |
| Framework dispatch (wx/EH/Lua/reflection) | `8` | 0.44% |
| **Caller functions unrecovered** (`NEEDS_RECOVERED_CALLER` — recover the parent first) | `849` | 46.29% |
| No indexed callsite evidence (needs investigation/evidence) | `608` | 33.15% |
