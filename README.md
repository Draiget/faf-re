...
- Progress coverage:  **`99.68%`**
  ...
  - *Total amount of completed tokens: `66,956`*

Progress DB status breakdown:

- `recovered`: `52,815` (78.88%)
- `skip`: `8,346` (12.46%) — proven ICF aliases / thunks / EH or static-init glue with no distinct source body
- `external_dependency`: `5,795` (8.65%) — proven third-party/import-boundary code
...
| No callsite evidence (no recorded code/data caller in the index) | `22,252` | 42.13% |
