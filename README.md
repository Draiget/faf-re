...
### Recovered (53,621 functions) — binary caller context
...
### Not-yet-recovered (2,070 blocked + needs_evidence) — backlog readiness

| Bucket | Count | % of backlog |
|---|---:|---:|
| **Candidate** (`OK_RECOVERED_CALLER` — caller token recovered; inspect its body) | `277` | 13.38% |
| Vtable-anchored (recover with the owning class) | `116` | 5.60% |
| Framework dispatch (wx/EH/Lua/reflection) | `1` | 0.05% |
| **Caller functions unrecovered** (`NEEDS_RECOVERED_CALLER` — recover the parent first) | `762` | 36.81% |
| No indexed callsite evidence (needs investigation/evidence) | `912` | 44.06% |
