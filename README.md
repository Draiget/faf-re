...
### Recovered (53,623 functions) — binary caller context

| Bucket | Count | % of recovered |
|---|---:|---:|
| **Recovered caller token exists** (source edge still requires verification) | `15,848` | 29.55% |
...
| No recovered caller token yet (orphan risk) | `2,456` | 4.58% |
| No callsite evidence (no recorded code/data caller in the index) | `23,714` | 44.22% |
