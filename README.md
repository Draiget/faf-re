...
- Progress coverage:  **`97.02%`**
  ...
  - *Total amount of completed tokens: `65,165`*

Progress DB status breakdown:

- `recovered`: `53,283` (81.77%)
...
### Recovered (53,283 functions) — wiring health

| Bucket | Count | % of recovered |
|---|---:|---:|
| **Confirmed caller** (recovered binary caller wired by name) | `15,343` | 28.80% |
...
| Caller still blocked (orphan-helper risk — caller awaits recovery) | `2,657` | 4.99% |
