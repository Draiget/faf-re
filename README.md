...
### Recovered (53,414 functions) — wiring health

| Bucket | Count | % of recovered |
|---|---:|---:|
| **Confirmed caller** (recovered binary caller wired by name) | `15,589` | 29.19% |
...
| Caller still blocked (orphan-helper risk — caller awaits recovery) | `2,554` | 4.78% |
| No callsite evidence (no recorded code/data caller in the index) | `23,710` | 44.39% |
