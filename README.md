...
### Recovered (53,464 functions) — wiring health

| Bucket | Count | % of recovered |
|---|---:|---:|
| **Confirmed caller** (recovered binary caller wired by name) | `15,643` | 29.26% |
...
| No callsite evidence (no recorded code/data caller in the index) | `23,711` | 44.35% |
