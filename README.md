...
### Recovered (53,390 functions) — wiring health

| Bucket | Count | % of recovered |
|---|---:|---:|
| **Confirmed caller** (recovered binary caller wired by name) | `15,546` | 29.12% |
...
| Caller still blocked (orphan-helper risk — caller awaits recovery) | `2,573` | 4.82% |
