...
- `recovered`: `53,232` (80.17%)
- `skip`: `7,394` (11.14%) — proven ICF aliases / thunks / EH or static-init glue with no distinct source body
...
### Recovered (53,232 functions) — binary caller context

| Bucket | Count | % of recovered |
|---|---:|---:|
| **Recovered caller token exists** (source edge still requires verification) | `16,959` | 31.86% |
...
| No recovered caller token yet (orphan risk) | `1,714` | 3.22% |
