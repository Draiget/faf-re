...
- `recovered`: `53,721` (82.25%)
- `skip`: `6,109` (9.35%) — proven ICF aliases / thunks / EH or static-init glue with no distinct source body
...
### Recovered (53,721 functions) — binary caller context

| Bucket | Count | % of recovered |
|---|---:|---:|
| **Recovered caller token exists** (source edge still requires verification) | `16,042` | 29.86% |
...
| No recovered caller token yet (orphan risk) | `2,395` | 4.46% |
