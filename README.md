...
- `recovered`: `52,740` (81.84%)
- `skip`: `6,267` (9.73%) — proven ICF aliases / thunks / EH or static-init glue with no distinct source body
...
| No callsite evidence (no recorded code/data caller in the index) | `22,898` | 43.42% |
