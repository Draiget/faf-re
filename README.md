...
- **`blocked`: `1,187` (1.77%)**
  ...
  - *combined with `needs_evidence`, the "not-yet-recovered non-engine-external" bucket is `1,595`*
  - *the `stats` tool's `blocked_count` aggregates the same two buckets and reports `1,595`*
