...
- `recovered`: `52,805` (80.75%)
- `skip`: `7,082` (10.83%) — proven ICF aliases / thunks / EH or static-init glue with no distinct source body
...
### Recovered (52,805 functions) — binary caller context

| Bucket | Count | % of recovered |
|---|---:|---:|
| **Recovered caller token exists** (source edge still requires verification) | `16,417` | 31.09% |
...
| No callsite evidence (no recorded code/data caller in the index) | `22,862` | 43.30% |
