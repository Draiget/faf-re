...
- Progress coverage:  **`96.51%`**
  ...
  - *Total amount of completed tokens: `64,821`*

Progress DB status breakdown:

- `recovered`: `52,934` (81.66%)
...
### Recovered (52,934 functions) — wiring health

| Bucket | Count | % of recovered |
|---|---:|---:|
| **Confirmed caller** (recovered binary caller wired by name) | `14,802` | 27.96% |
