...
- Progress coverage:  **`96.42%`**
  ...
  - *Total amount of completed tokens: `64,760`*

Progress DB status breakdown:

- `recovered`: `52,873` (81.64%)
...
### Recovered (52,873 functions) — wiring health

| Bucket | Count | % of recovered |
|---|---:|---:|
| **Confirmed caller** (recovered binary caller wired by name) | `14,712` | 27.83% |
