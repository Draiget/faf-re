...
- `recovered`: `53,293` (80.09%)
- `skip`: `7,477` (11.24%) — proven ICF aliases / thunks / EH or static-init glue with no distinct source body
- `external_dependency`: `5,770` (8.67%) — proven third-party/import-boundary code
...
### Recovered (53,293 functions) — binary caller context

| Bucket | Count | % of recovered |
|---|---:|---:|
| **Recovered caller token exists** (source edge still requires verification) | `17,093` | 32.07% |
| Vtable-anchored (virtual override of a recovered class) | `5,882` | 11.04% |
| Framework dispatch (wx event, EH handler, Lua binding, reflection table, …) | `5,572` | 10.46% |
| No recovered caller token yet (orphan risk) | `1,697` | 3.18% |
| No callsite evidence (no recorded code/data caller in the index) | `22,829` | 42.84% |
